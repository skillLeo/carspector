    ...
    return {
        init: function () {
            o && (o.querySelectorAll("tbody tr").forEach((e => {
                ...
                info: !1,
                ajax: {
                    "url": hostUrl+'admin/fetch-reviews',
                    "type": "GET",
                    "data": function ( d ) {

                        d.status=$('.check-status').val();
                ...
                columns:[
                    ...
                    {data:'examiner.name',render:function(data,row,full){
                            console.log(full);
                            if(full.examiner) {
                                let myHtml = '<div class="symbol symbol-circle symbol-50px overflow-hidden me-3">\n' +
                    ...
                    {data:'rating_with_examiner'},
                    {data:'rating_about_examiner'},
                    {data:'created_at'},
