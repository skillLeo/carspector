    ...
    //This how we intiate it and extend the bs funcionality:
    var dropdown = new SikDropdown("#sik-selectOne", {
        name: "select-example", // the input field name
    placeholder: "Select",
    value: null
    });
    //This how we intiate it and extend the bs funcionality:
    var dropdown = new SikDropdown("#sik-selectTwo", {
        name: "select-example", // the input field name
    placeholder: "Select",
    value: null
    });
    ...
    //This how we intiate it and extend the bs funcionality:
    var dropdown = new SikDropdown("#sik-selectThree", {
        name: "select-example", // the input field name
    placeholder: "von",
    value: null
    });
    //This how we intiate it and extend the bs funcionality:
    var dropdown = new SikDropdown("#sik-selectFour", {
        name: "select-example", // the input field name
    placeholder: "von",
    value: null
    });
