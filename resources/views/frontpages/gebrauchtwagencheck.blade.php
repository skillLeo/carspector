...
@section('title', 'Carspector | Auto/ PKW Check ')
@section('meta_description', 'Lass deinen gewünschten PKW vor dem Kauf professionell prüfen – unabhängig, objektiv und nach höchsten Standards. Für maximale Sicherheit beim Autokauf.')
@section('header')
...
<div class="modal fade" id="fin-model" tabindex="-1" aria-labelledby="stepDescModalLabel" aria-hidden="true">
    ...
    <div class="container d-flex align-items-center justify-content-between">
        <div class="content-box" style="flex: 1;">
            <h3 class="section-title fs-3 text-primary pb-2">Auto/ PKW Check</h3>
            <div class="text-grey pb-2 mb-1">
                <i style="color: #f2d414" class="fa-solid fa-star"></i> 4.8 (1.911)
            </div>
            <p style="max-width: 470px; margin-left: auto; margin-right: auto;">
                Unsere Experten prüfen dein gewünschtes Auto <br class="desktop-only-br">direkt beim Verkäufer – unabhängig, professionell <br class="desktop-only-br">und nach über 150 Prüfpunkten.
            </p>
            <a href="{{route('booking.step-2',['type'=>('Auto/ PKW')])}}" class="btnwd nextStep btn btn-secondary mt-4">
                Jetzt buchen
        ...
        <div class="image-box d-none d-xl-block" style="flex: 0.5; text-align: center; margin-left: 20px;">
            <img src="theme-1/imgs/vorteile/main.png" alt="auto pkw gebrauchtwagencheck" style="max-width: 100%; height: 295px; border-radius: 5px;">
        </div>
    </div>
...
<section class="pad-top-inhalt steps-area pb-5 pb-md-5">
 ...
 <div class="section-head text-center pb-4 mb-3">
  ...
  <div style="max-width: 1200px; margin: 0 auto; text-align: center;">
    ...
    <a href="{{route('booking.step-2',['type'=>('Auto/ PKW')])}}" class="btn btn-secondary mt-5" style="border-radius: 5px; padding: 15px 60px">
          Jetzt starten
                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="card-item text-primary d-flex flex-column justify-content-between text-center bg-white">
                            <div class="card-item-head">
                                ...
                                <h4 class="card-title fw-bold pt-1 pb-2">Umfassender Zustandsbericht</h4>
                            </div>
            ...
            <div class="container">
                <div class="advantage-wrapper">
                    ...
                    <div class="pt-5 d-flex flex-column align-items-center justify-content-center">
                        <a href="{{route('booking.step-2',['type'=>('Auto/ PKW')])}}" style="width: 350px; border-radius: 5px" class="btnwdnextStep btn btn-secondary ">
                                Jetzt buchen
            ...
            <div class="container">
                <div
                    ...
                    <div class="d-flex flex-column align-items-center justify-content-center">
                        <a href="{{route('booking.step-2',['type'=>('Auto/ PKW')])}}" style="width: 350px; border-radius: 5px" class="nextStep btn btn-secondary ">
