...
@section('title', 'Gebrauchtwagencheck in ganz Deutschland – geprüft & vor Ort')
@section('meta_description', 'Jetzt Gebrauchtwagencheck in ganz Deutschland buchen – umfassende Vor-Ort-Prüfung mit über 150 Prüfpunkten, Fotodokumentation & Marktwertanalyse.')
@section('header')
...
<script type="application/ld+json">
{
  ...
  "@type" => "Service",
  "name" => "Gebrauchtwagencheck in ganz Deutschland",
  "description" => "Wir fahren zu dem Fahrzeug, das du kaufen möchtest, und prüfen es direkt vor Ort!",
  "url" => "https://carspector.de/standorte/gebrauchtwagencheck-deutschlandweit"
  "areaServed": "DE",
  "provider" => [
      "@type" => "Organization",
      "name" => "Carspector",
  ...
  <div class="container">
    <div class="row align-items-center g-4">
      ...
      <div class="col-lg-6 text-center text-lg-start">
        ...
        <h1 class="hero-title">
          Gebrauchtwagen-Check in ganz Deutschland
        </h1>
...
<!-- 
  ...
  <div style="max-width: 1200px; margin: 0 auto; text-align: center;">
    <h3 style="color: var(--primary); margin-bottom: 60px">So funktioniert der Gebrauchtwagencheck in ganz Deutschland</h3>
...
<section class="checklist-section py-5">
  ...
  <div class="container">
     <h3 class="section-title fs-3 fw-bold text-primary text-center mb-3">
      Deine Vorteile unseres Gebrauchtwagen-Checks in ganz Deutschland
    </h3>
    ...
    .img-responsive-custom {
      max-width: 375px; /* Desktop normal groß */
        ...
        <section class="faq-section">
            <div class="container">
                <h3 class="section-title fs-3 fw-bold text-primary text-center pb-5 mb-2">Fragen zum Gebrauchtwagencheck in ganz Deutschland
                </h3>
