...
@section('title', 'Gebrauchtwagencheck in Brandenburg – zertifiziert & vor Ort')
@section('meta_description', 'Jetzt Gebrauchtwagencheck in Brandenburg buchen – zertifizierte Vor-Ort-Prüfung mit über 150 Prüfpunkten, Fotodokumentation & Marktwertanalyse.')
@section('header')
...
<script type="application/ld+json">
{
  ...
  "@type": "Service",
  "name": "Gebrauchtwagencheck Brandenburg",
  "description": "Wir fahren zu dem Fahrzeug, das du kaufen möchtest, und prüfen es direkt vor Ort!",
  "url": "https://carspector.de/standorte/gebrauchtwagencheck-brandenburg",
  "areaServed": {
    "@type": "Place",
    "name": "Brandenburg"
  },
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <div id="popupContent" class="pb-2" style="text-align: left;">
                                                        <b>Wir bieten unsere Dienstleistungen nicht nur in Brandenburg, sondern deutschlandweit an.</b>
                                                        <br><br>
                                                        <div style="display: inline-flex; align-items: left; margin-bottom: 10px;">
                                                            ...
                                                            <span style="color: #000; font-size: 1.0em;"> Vor-Ort-Check in Brandenburg</span>
                                                        </div><br>
                                                        <div style="display: inline-flex; align-items: left; margin-bottom: 10px;">
                                                            <i class="fa fa-check" style="color: var(--secondary); font-size: 1.2em; margin-right: 13px; padding-left: 5px"></i>
...
<div class="mobile-menu d-xl-none">
  <div class="offcanvas offcanvas-end bg-primary" tabindex="-1" id="offcanvasRight" aria-labelledby="offcanvasRightLabel">
    ...
    <div class="pad-top container">
        <div class="hero-wrapper mx-auto text-center">
            <h1 style="letter-spacing: -2px; font-size: 75px; padding-bottom: 20px" class="pad-para-f tlemain section-title text-white fw-bold">Gebrauchtwagen-Check in <span class="animate-check" style="color: var(--secondary)">Brandenburg</span></h1>
                    ...
                    <ul class="main-hero-para d-flex flex-column flex-md-row flex-wrap justify-content-center align-items-center gap-1 gap-md-3" 
                        ...
                        <li class="d-flex align-items-center gap-2 text-center" style="color: var(--secondary); margin-top: 3px;">
                            ...
                            <span style="font-size: 17px; letter-spacing: 0.1px" class="para-space text-white">Vor-Ort-Check in Brandenburg</span>
                        ...
                        <div class="col-md-6">
                            <div class="ucc-text text-center text-md-start p-lg-5 pe-0">
                                ...
                                <p style="font-size: 17px" class="pt-2 pb-4 text-primary">
                                    Wir fahren zu deinem gewünschten Fahrzeug in Brandenburg und führen einen umfassenden Gebrauchtwagencheck vor Ort durch!
                                </p>
  ...
  <div style="max-width: 1200px; margin: 0 auto; text-align: center;">
    <h3 style="color: var(--primary); margin-bottom: 60px">So funktioniert der Gebrauchtwagencheck in Brandenburg</h3>
...
<section class="checklist-section py-5">
  ...
  <div class="container">
    <h3 class="section-title fs-3 fw-bold text-primary text-center mb-3 pt-2">
      Deine Vorteile unseres Gebrauchtwagen-<br>Checks in Brandenburg
    </h3>
          ...
          <div class="swiper-slide" style="height: auto; min-height: 475px; display: flex; justify-content: center;">
            <div class="card shadow border-0 rounded mx-auto" style="max-width: 350px;">
              ...
              <div class="card-body">
                ...
                <p class="mb-2" style="color: var(--secondary); font-size: 1.2rem;">★★★★★</p>
                <p class="card-text text-dark" style="font-size: 0.95rem;">
                  Als Laie sparte ich mir den Weg Hamburg → Brandenburg: Carspector schickte den Gutachter. Händler erschien nicht, Carspector prüfte an einem neuen Termin – top Service!
                </p>
              </div>
            </div>
          </div>
    ...
    .img-responsive-custom {
      max-width: 375px; /* Desktop normal groß */
        ...
        <section class="faq-section">
            <div class="container">
                <h3 class="section-title fs-3 fw-bold text-primary text-center pb-5 mb-2">Fragen zum Gebrauchtwagencheck in Brandenburg
                </h3>
