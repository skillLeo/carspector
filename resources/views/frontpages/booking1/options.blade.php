...
<main>
    ...
    <!-- hero-area-start -->
    <section class="section hero-area position-relative z-1 header-two">
        <div class="container">
            <div class="hero-wrapper">
                ...
                <div class="hero-content m-auto">
                    ...
                    <p style="letter-spacing: 0.1px" class="hero-para text-center text-white m-auto">Wir prüfen dein gewünschtes Fahrzeug vor dem Kauf und erstellen ein zertifiziertes Gutachten.</p>
                        ...
                        <form action="{{route('booking.option-page')}}" class="m-auto">
                            ...
                            <div>
                                <div class="input-box input-box-icon mb-0 flex-grow-1">
                                    ...
                                    <input type="text" name="city" placeholder="Stadt/ PLZ" class="form-control shadow-1">
                                </div>
                ...
                <div class="row flex-column-reverse flex-lg-row g-0 not-anymore-wrapper-row">
                    ...
                    <div class="col-lg-6">
                        <div class="not-anymore-text mt-xl-3">
                            <h2 class="not-anymore-heading">Unsicher beim Kauf?</h2>
                            <p class="paragraph not-anymore-para mb-4"><b>Kein Problem!</b> Mit unserem Bericht bist du bestens über den technischen sowie optischen Zustand informiert und kannst mit unserer Kaufempfehlung eine fundierte Entscheidung treffen. </p>
                            <div class="not-anypore-check d-flex align-items-center gap-4 mb-4">
                    <span class="flex-shrink-0">
                      <img src="front-home/imgs/icons/check-primary.svg" alt="">
                    </span>
                                <p class="paragraph">Zertifizierte Prüfer</p>
                            </div>
            ...
            <span class="ratings-check flex-shrink-0">
              <img src="front-home/imgs/icons/ratings-check.svg" alt="">
                ...
                <div class="ratings-content">
                    <h2 class="ratings-heading">Für deine Sicherheit beim Autokauf</h2>
                      ...
                      <span class="sac-icon flex-shrink-0 d-inline-flex justify-content-center align-items-center">
                        <img src="front-home/imgs/icons/advantages-icons/advantage-icon-1.png" alt="">
                                    ...
                                    <div class="sac-info">
                                        ...
                                        <p class="mb-0">Sicherheit beim Kauf</p>
                                    </div>
                                </div>
        ...
        <div class="container">
            ...
            <span class="ratings-check flex-shrink-0">
              <img src="front-home/imgs/icons/ratings-check.svg" alt="">
                ...
                <div class="ratings-content">
                    <h2 class="ratings-heading">Einfach. Sicher. Kaufen.</h2>
                </div>
            </div>
        </div>
    </section>
        ...
        <form action="{{route('booking.option-page')}}" style="margin: auto !important;">
            ...
            <div class="d-flex gap-1 gap-md-2 w-100 align-items-center  flex-md-row mobile-hero-area-btns">
                <div class="input-box input-box-icon mb-0 flex-grow-1 align-items-center">
                    ...
                    <input name="city" type="search" pattern="[A-Za-zäöüÄÖÜß\s]+.*[^ ].*" placeholder="Stadt/ PLZ" class="form-control input-shadow-1" required>
                </div>
