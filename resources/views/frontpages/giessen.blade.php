...
@section('title', 'Gebrauchtwagencheck in Gießen – geprüft & vor Ort')
@section('meta_description', 'Jetzt Gebrauchtwagencheck in Gießen buchen – umfassende Vor-Ort-Prüfung mit über 150 Prüfpunkten, Fotodokumentation & Marktwertanalyse.')
@section('header')
...
<script type="application/ld+json">
{
  ...
  "@type" => "Service",
  "name" => "Gebrauchtwagencheck in Gießen",
  ...
  <div class="container">
    <div class="row align-items-center g-4">
      ...
      <div class="col-lg-6 text-center text-lg-start">
        ...
        <h1 class="hero-title">
          Gebrauchtwagen-Check in Gießen
        </h1>
        ...
        <ul style="padding-top: 3px" class="hero-bullets">
          <li class="d-flex align-items-center gap-2">
            ...
            <span>&nbsp;Vor-Ort-Check in Gießen</span>
...
<section class="checklist-section py-5">
  ...
  <div class="container">
     <h3 class="section-title fs-3 fw-bold text-primary text-center mb-3">
      Deine Vorteile unseres Gebrauchtwagen-Checks in Gießen
    </h3>
