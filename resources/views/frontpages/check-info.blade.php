...
@section('title', 'Carspector | Check-Info')
...
/* Desktop: Elemente etwas näher zusammen */
@media (min-width: 992px) {
    .header-wrapper {
        max-width: 1000px; /* vorher vermutlich 1400–1600 */
        padding-left: 20px;
        padding-right: 20px;
    }
}
...
<a href="#tel" data-bs-target="#tel" data-bs-toggle="modal" class=" mobile-call-btn d-flex justify-content-center align-items-center">
    ...
    <main class="main-area overflow-hidden"> 
     ...
     <div id="stickyBar">
        <div id="stickyButton" onclick="window.location.href='https://carspector.de/buchung-s4';">Jetzt Check beauftragen</div>
    </div>
...
<header class="header position-relative z-3">
    <div class="header-wrapper index-header d-flex align-items-center justify-content-center justify-content-md-between mx-auto position-relative">
        ...
        <div class="header-logo">
            <a href="#" class="logo d-inline-flex align-items-center gap-3">
    ...
    <a href="https://carspector.de/buchung-s4" style="border-radius: 5px !important" class="btn-wid btn btn-secondary main-hero-btn-1">
  ...
  <div style="max-width: 1200px; margin: 0 auto; text-align: center;">
    ...
    <a href="https://carspector.de/buchung-s4" class="btn btn-secondary mt-5" style="border-radius: 5px; padding: 15px 60px">
          Jetzt Check beauftragen
...
<div class="d-flex flex-wrap justify-content-center mb-4" style="gap: 10px; font-size: 1rem;">
  ...
  <a href="https://carspector.de/buchung-s4" class="btn btn-secondary px-4 py-2 fw-semibold" style="height: 55px; width: min(95%, 350px); border-radius: 25px;">
    Jetzt Check beauftragen
    <span class="btn-icon ms-1">
      <img src="theme-1/imgs/icons/arrowr.png" style="height: 18px;" alt="weiter zum Angebot">
    </span>
  </a>  <p class="pt-3" style="font-size: 15px">⭐ 2.500+ zufriedene Kunden</p>
</div>
  </div> 
  ...
  <div class="container">
    <div class="row align-items-center flex-column-reverse flex-md-row">
      ...
      <div class="col-md-6 text-center text-md-start">
        ...
        <a href="https://carspector.de/buchung-s4" class="btn btn-secondary mt-4" style="border-radius: 5px; padding: 15px 40px">
          Jetzt Check beauftragen
          <span class="btn-icon ms-2">
            <img src="theme-1/imgs/icons/arrowr.png" style="height: 21px;" alt="weiter zur Buchung">
          </span>
                    ...
                    <div class="accordion accordion-flush" id="accordionFlushExample">
                                            ...
                                            <div style="margin-bottom: 15px !important; border-radius: 5px" class="accordion-item">
                                              ...
                                              <div id="faq-four3" class="accordion-collapse collapse" data-bs-parent="#accordionFlushExample">
                                                  <div class="accordion-body">
      Über <a href="https://carspector.de/buchung-s4">dieses Formular</a> erhältst du ganz einfach dein persönliches Angebot direkt in dein Postfach und kannst den Fahrezug-Check dort mühelos beauftragen.
...
<section id="angebot-formular" class="contact-section py-5">
  <h3 style="max-width: 95% !important; margin: 0 auto" class="text-primary text-center fw-bold mb-3">
    Jetzt unverbindlich anfragen
  </h3>
  <p style="max-width: 95% !important; font-size: 0.95rem; margin: 0 auto" class="text-center text-muted mb-4">
   Trage deine E-Mail ein und erhalte eine klare Übersicht über Preise, Ablauf, Prüfumfang und ein Beispiel-Gutachten - unverbindlich & kostenlos.
  </p>

  <div class="pb-4 pt-2 container" style="max-width: 550px;">

    <form action="{{ route('landingtest23.submit') }}" method="POST"
      ...
      <div class="mb-3">
  <label for="email" class="pb-1 form-label fw-semibold d-flex align-items-center">
    <span 
      style="
        display: inline-flex; 
        align-items: center; 
  ...
  <input
    ...
    style="border: 1px solid #8d8d8dff; background-color: #f9f9f9ff;"
  ...
  emailField.addEventListener("input", () => {
    hiddenName.value = emailField.value;
  });
</script>
...
<!-- <div class="form-check mb-2">
  <input 
    style="
      ...
      transform: scale(1.2);        /* Checkbox vergrößern */
  ...
  >
  <label style="font-size: 14px !important" class="form-check-label" for="privacyCheck">
   Ich akzeptiere die <a href="https://www.carspector.de/datenschutz">Datenschutzbedingungen</a>.
  </label>
</div>
...
<div class="text-center pt-1 mb-3">
  <button 
    ...
    style="
      ...
      opacity: 1;
    "
    class="btn btn-secondary px-5 py-3 fw-semibold rounded-pill"
  >
    Kostenloses Angebot erhalten
  </button>
</div>

   <p class="text-muted text-center mb-3" style="font-size: 0.85rem;">
...
<div class="pt-2">
        <ul class="list-unstyled text-start" style="font-size: 0.95rem; line-height: 1.55;">
          ...
          <li class="d-flex mb-2">
            <span class="me-2">✔️</span>
            Alle Preise & Leistungen auf einen Blick
          </li>
          <li class="d-flex mb-2">
            <span class="me-2">✔️</span>
 ...
 <div class="pt-2">
  <ul class="list-unstyled text-start" style="font-size: 0.95rem; line-height: 1.55;">
    ...
    <li class="d-flex mb-2">
      <i class="fa-solid fa-check me-2" style="color: var(--secondary); font-size: 1.2rem;"></i>
      Individuelles & unverbindliches Angebot
    </li>
    ...
    <li class="d-flex mb-1">
      ...
      <p class="text-center pt-3 mb-0" style="font-size: 0.9rem;">
        Du erhältst alle Informationen innerhalb weniger Sekunden direkt an deine E-Mail-Adresse.
      </p>
    </form>
  </div>
</section> -->
            ...
            <div class="container">
                <div class="advantage-wrapper">
                    ...
                    <div class="pt-5 d-flex flex-column align-items-center justify-content-center">
                        <a href="https://carspector.de/buchung-s4" style="width: 350px; border-radius: 5px" class="btnwdnextStep btn btn-secondary ">
                                Jetzt Check beauftragen
...
<script>
  // Smooth Scroll für CTAs, die auf https://carspector.de/buchung-s4 verlinken
...
.proud-wrapper {
  ...
  border-radius: 5px;
        ...
        document.addEventListener("scroll", function () {
            ...
            if (scrollY > 900 && scrollY < scrollHeight - viewportHeight - 1200) {
