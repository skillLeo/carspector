                    ...
                    <center><div class="col-lg-4">
                            ...
                            <div class="exam-card-header">
                                    <div class="exam-card-header-icon">
                                        <img src="assets/imgs/iconoption/sedan.png" alt="Auto PKW Gebrauchtwagencheck prüfung">
                                    </div><p style="text-align: left; font-size: 20px; font-weight: bold; padding-top: 15px">Auto/ PKW Prüfung</p>
                                </div>
                                <div id="multiCollapseExample1" class="multi-collapse show d-lg-block">
                                    <ul class="mb-4">
                                        <li>
                                            <span class="icon"><img src="front/imgs/icons/check-faq.png" alt="auto pkw vor dem kauf prüfen lassen" height="25px"></span>
                                            PKW aller Bauarten
                                        </li>
                                        <li>
                                            <span class="icon"><img src="front/imgs/icons/check-faq.png" alt="transporter kleintransporter prüfung" height="25px"></span>
                                            Kleintransporter
                                        </li>
                    ...
                    <div class="row g-lg-5 g-md-4 g-sm-3 pb-4">
                        ...
                        <div class="col-sm-6 col-lg-4">
                            <div class="exam-card">
                                <div class="exam-card-header">
                                    <div class="exam-card-header-icon">
                                        <img src="assets/imgs/iconadv/business-report.png" alt="zertifiziertes gebrauchtwagen gutachten">
