...
@section('title', 'Carspector | Check')
...
<a href="#tel" data-bs-target="#tel" data-bs-toggle="modal" class=" mobile-call-btn d-flex justify-content-center align-items-center">
    ...
    <main class="main-area overflow-hidden"> 
     ...
     <div id="stickyBar">
        <div id="stickyButton" onclick="window.location.href='#angebot-formular';">Jetzt kostenlos anfragen</div>
    </div>
...
<div style="text-align: center; padding-top: 40px">
  <a href="#angebot-formular" class="btn btn-secondary px-4 py-2 fw-semibold"
     style="height: 55px; width: min(95%, 350px)">
    Jetzt kostenlos anfragen
    <span class="btn-icon ms-1">
      <img src="theme-1/imgs/icons/arrowr.png" style="height: 18px;" alt="weiter zum Angebot">
    </span>
...
<div class="text-center pt-1 mb-3">
  ...
  <!-- <p class="text-muted mb-3" style="font-size: 0.85rem;">
        ...
        und kannst später ganz in Ruhe entscheiden. Mit dem Absenden akzeptierst du unsere Datenschutzbestimmungen.
      </p>  -->
...
.proud-wrapper {
  ...
  border-radius: 5px;
        ...
        document.addEventListener("scroll", function () {
            ...
            if (scrollY > 900 && scrollY < scrollHeight - viewportHeight - 2000) {
