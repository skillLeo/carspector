...
{{--                                        </div>--}}
                                        ...
                                        <!-- <div class="mb-3 input-box">
                                            <div class="input-group">
                                                ...
                                                <button class="btn btn-sm d-flex align-items-center justify-content-center text-center" type="button"
                                ...
                                <div style="text-align: center">
                                    ...
                                    <div class="pt-3 vehicle-info-bottom">
                                        ...
                                        <hr style="border: 1px solid var(--secondary); width: 100%; max-width: 600px; margin: 10px auto;">

                                        @if(request('type')=='kaufbegleitung')
                                        <p class="pt-1" style="font-size: 17px; text-align: center; color: var(--primary); max-width: 600px">Unser Prüfer nimmt direkt Kontakt mit dir auf, um einen passenden Termin zur Fahrzeugbesichtigung zu vereinbaren.</p>
                                        @else
                                        <p class="pt-1" style="font-size: 17px; text-align: center; color: var(--primary); max-width: 600px">Wir übernehmen die Kontaktaufnahme zum Verkäufer und vereinbaren umgehend einen Besichtigungstermin.</p>
                                        @endif
        ...
        <script>
            ...
            const fixedEndDate = new Date("2025-03-10T23:59:59"); // Endzeitpunkt festlegen
