...
@if($__showCalcs)
@include('frontpages.vehicle.partials.cost_calculations', ['damages' => $calcDamages ?? collect(), 'damageSummary' => $damageSummary ?? null, 'order' => $order])
@endif
...
<div style="page-break-inside: avoid;">
  ...
  <div style="min-height: 25mm; position: relative;">
    ...
    <div style="position: absolute; bottom: 0; left: 0; right: 0;
      ...
      Hinweis: Dieser Zustandsbericht basiert auf einer Sicht- und Funktionsprüfung zum Zeitpunkt der Besichtigung.
Verdeckte oder nicht erkennbare Mängel können nicht ausgeschlossen werden.
Der Bericht stellt keine Garantie oder Haftungsübernahme dar.
    </div>
