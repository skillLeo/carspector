...
@section('title', 'Carspector | Oldtimer-Check')
@section('meta_description', 'Lass deinen gewünschten Oldtimer vor dem Kauf gründlich prüfen – mit Erfahrung, Sensibilität für Details und geprüfter Fahrzeughistorie.')
@section('header')
...
<div class="modal fade" id="fin-model" tabindex="-1" aria-labelledby="stepDescModalLabel" aria-hidden="true">
    ...
    <main class="main-area">
        ...
        <div class="content-box" style="flex: 1;">
                    <h3 class="section-title fs-3 text-primary pb-2">Oldtimer-Check</h3>
                    <div class="text-grey pb-2 mb-1"><i style="color: #f2d414" class="fa-solid fa-star"></i> 4.8 (1.048)
                    </div>
                    <p style="max-width: 470px; margin-left: auto; margin-right: auto;">
                        Unsere Experten prüfen deinen gewünschten Oldtimer <br class="desktop-only-br">direkt beim Verkäufer – unabhängig, professionell <br class="desktop-only-br">und nach über 150 Prüfpunkten.
                    </p>
                    <a href="{{route('booking.step-2',['type'=>('oldtimer')])}}" class="btnwd nextStep btn btn-secondary mt-4">
                        Jetzt buchen
                        <span class="btn-icon"><img src="theme-1/imgs/icons/arrowr.png" style="height: 21px" alt="oldtimer"></span>
                    </a>
                    </div>
                <div class="image-box d-none d-xl-block" style="flex: 0.5; text-align: center; margin-left: 20px;">
                    <img src="theme-1/imgs/vorteile/oldtimer.png" alt="oldtimer gutachten" style="max-width: 100%; height: 315px; border-radius: 5px;">
                </div>
            </div>
            <div class="image-box d-block d-xl-none pt-4" style="flex: 0.5; text-align: center;">
                    <img src="theme-1/imgs/vorteile/oldtimer.png" alt="oldtimer" style="max-width: 90%; max-height: 315px; border-radius: 5px">
            </div>
        </section>
...
<section class="pad-top-inhalt steps-area pb-5 pb-md-5">
                <form action="{{route('booking.step-3',['type'=>('')])}}" method="GET">
                    <input type="hidden" name="type" value="oldtimer">
                <div class="container">
 ...
 <div class="section-head text-center pb-4 mb-3">
                                                        ...
                                                        <label for="check1" class="active" id="nav-home-tab" data-bs-toggle="tab"
                                                            ...
                                                            <span class="ind">
                                                                ...
                                                                <div class="check-nav-content">
                                                                    <h5>Check XL</h5>
                                                                    <p>Umfassender Oldtimer-Check</p>
                                                                    <div class="rattings">
                                                                    <span class="star">
                                                                    <i style="color: #f2d414" class="fa-solid fa-star"></i>
                                                                    </span>
                                                                        <span class="ratting-text">4.8 (344)</span>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                    ...
                                                    <div class="check-nav">
                                                        ...
                                                        <label for="check2" class="" id="nav-profile-tab"
                                                            ...
                                                            <span class="ind">
                                                                ...
                                                                <div class="check-nav-content">
                                                                    <h5>Check XXL</h5>
                                                                    <p>Umfassender Oldtimer-Check + FIN-Abfrage & Berechnung
                                                                    </p>
                                                                    <div class="rattings">
                                                                    <span class="star">
                                                                    <i style="color: #f2d414" class="fa-solid fa-star"></i>
                                                                    </span>
                                                                        <span class="ratting-text">4.8 (704)</span>
                                                                    </div>
                                                                </div>
                                                            </div>
                                        ...
                                        <div class="tab-content row" id="nav-tabContent">
                                            <div class="tab-pane active show fade col-md-6" id="nav-home" role="tabpanel"
                                                ...
                                                <div class="check-content">
                                                    ...
                                                    <!-- <div class="check-cotnent-footer">
                                                        <h6 style="font-size: 17px; letter-spacing: -0.25px">
                                                            <b>
                                                                <span style="background-color: var(--primary); color: white; padding: 5px 10px; border-radius: 5px">299 €</span>
                                                            </b>
                                                        </h6>
                                                        <p style="padding-top: 12px; font-size: 16px; color: black; font-weight: bold">
                                                            Anfahrt: <span style="text-decoration: line-through; color: #dc3545">30 €</span> 0 € 
                                                            <span style="background-color: var(--secondary); color: white; padding: 2px 5px; border-radius: 3px; margin-left: 5px">SALE</span>
                                                        </p> 
                                                    </div> -->
                                                    ...
                                                    <!-- <div class="check-cotnent-footer">
                                                    <h6>Preis: <b>299 €</b></h6>
                                                        <p class="pt-1" style="font-size: 16px; color: black; font-weight: bold">
                                                            Anfahrt: <span style="text-decoration: line-through; color: #dc3545">30 €</span> 0 € 
                                                            <span style="background-color: var(--secondary); color: white; padding: 2px 5px; border-radius: 3px; margin-left: 5px">SALE</span>
                                                        </p>
                                                    </div> -->
  ...
  <div style="max-width: 1200px; margin: 0 auto; text-align: center;">
    <h3 style="color: var(--primary); margin-bottom: 60px">In 3 Schritten sicher zum neuen Oldtimer</h3>
    ...
    <a href="{{route('booking.step-2',['type'=>('oldtimer')])}}" class="btn btn-secondary mt-5" style="border-radius: 5px; padding: 15px 60px">
          Jetzt starten
                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="card-item text-primary d-flex flex-column justify-content-between text-center bg-white">
                            <div class="card-item-head">
                                ...
                                <h4 class="card-title fw-bold pt-1 pb-2">Oldtimer-Zustandsbericht</h4>
                            </div>
                            <p class="card-para text-black">Wir erstellen einen geprüften Oldtimer-Zustandsbericht, der eine professionelle und objektive Bewertung des gesamten Fahrzeugs bietet.</p>
                        </div>
                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="card-item text-primary d-flex flex-column justify-content-between text-center bg-white">
                            ...
                            <i class="fa-regular fa-clock-rotate-left"></i>
                                ...
                                <h4 class="card-title fw-bold pt-1 pb-2">Historien-Check</h4>
                            </div>
                            <p class="card-para text-black">Wir prüfen die Fahrzeughistorie gründlich und gewissenhaft, um ein Höchstmaß an Transparenz und Sicherheit zu gewährleisten.</p>
                        </div>
                    </div>
                    ...
                    <div class="row flex-column-reverse flex-md-row align-items-center">
                        <div class="col-md-6">
                            <div class="ucc-text p-lg-5 pe-0 text-center text-md-start">
                                <h3 class="section-title fs-3 fw-bold text-primary pb-2">Oldtimer-Check<br>vor Ort
                                </h3>

                                <div class="text-grey pb-2 mb-1 pt-1"><i style="color: #f2d414" class="fa-solid fa-star"></i>
                                                           4.8 (1.048 Bewertungen) </div>

                                <p class="pt-2 text-primary">
                                    Wir prüfen deinen gewünschten Oldtimer vor dem Kauf, damit du über den technischen und
            ...
            <div class="container">
                <div class="advantage-wrapper">
                    ...
                    <div class="pt-5 d-flex flex-column align-items-center justify-content-center">
                        <a href="{{route('booking.step-2',['type'=>('oldtimer')])}}" style="width: 350px; border-radius: 5px" class="btnwdnextStep btn btn-secondary ">
                                Jetzt buchen
            ...
            <div class="container">
                <div 
                    ...
                    <div class="d-flex flex-column align-items-center justify-content-center">
                        <a href="{{route('booking.step-2',['type'=>('oldtimer')])}}" style="width: 350px; border-radius: 5px" class="nextStep btn btn-secondary ">
                                Jetzt Oldtimer-Check buchen
                                <span class="btn-icon"><img src="theme-1/imgs/icons/arrowr.png" style="height: 21px" alt="gebrauchtwagencheck"></span>
                        </a>
                    </div>
                </div>
