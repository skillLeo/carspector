...
@section('title', 'Carspector | Elektro-Check ')
@section('meta_description', 'Lass dein gewünschtes Elektroauto vor dem Kauf professionell prüfen – inklusive Batterie-Check (SoH), Ladefunktion und Elektronikdiagnose.')
@section('header')
...
<div class="modal fade" id="fin-model" tabindex="-1" aria-labelledby="stepDescModalLabel" aria-hidden="true">
    ...
    <div class="container d-flex align-items-center justify-content-between">
        <div class="content-box" style="flex: 1;">
            <h3 class="section-title fs-3 text-primary pb-2">Elektro-Check</h3>
            <div class="text-grey pb-2 mb-1">
                <i style="color: #f2d414" class="fa-solid fa-star"></i> 4.8 (132)
            </div>
            <p style="max-width: 470px; margin-left: auto; margin-right: auto;">
                Unsere E-Auto-Experten prüfen dein gewünschtes Auto <br class="desktop-only-br">direkt beim Verkäufer – unabhängig, professionell <br class="desktop-only-br">und nach über 150 Prüfpunkten.
            </p>
            <a href="{{route('booking.step-2',['type'=>('elektro')])}}" class="btnwd nextStep btn btn-secondary mt-4">
                Jetzt buchen
        ...
        <div class="image-box d-none d-xl-block" style="flex: 0.5; text-align: center; margin-left: 20px;">
            <img src="theme-1/imgs/vorteile/elektro.png" alt="auto pkw gebrauchtwagencheck" style="max-width: 100%; height: 295px; border-radius: 5px;">
        </div>
    </div>
    <div class="image-box d-block d-xl-none pt-4" style="flex: 0.5; text-align: center;">
            <img src="theme-1/imgs/vorteile/elektro.png" alt="auto pkw gebrauchtwagencheck" style="max-width: 90%; max-height: 315px; border-radius: 5px">
    </div>
</section>
...
<section class="pad-top-inhalt steps-area pb-5 pb-md-5">
                <form action="{{route('booking.step-3',['type'=>('')])}}" method="GET">
                    <input type="hidden" name="type" value="elektro">
                <div class="container">
 ...
 <div class="section-head text-center pb-4 mb-3">
                                                        ...
                                                        <label for="check1" class="active" id="nav-home-tab" data-bs-toggle="tab"
                                                            ...
                                                            <span class="ind">
                                                                ...
                                                                <div class="check-nav-content">
                                                                    <h5>Check XL</h5>
                                                                    <p>Umfassender Elektro-Check</p>
                                                                    <div class="rattings">
                                                                    <span class="star">
                                                                        <i style="color: #f2d414" class="fa-solid fa-star"></i>
                                                                    </span>
                                                                        <span class="ratting-text">4.8 (15)</span>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                    ...
                                                    <div class="check-nav">
                                                        ...
                                                        <label for="check2" class="" id="nav-profile-tab"
                                                            ...
                                                            <span class="ind">
                                                                ...
                                                                <div class="check-nav-content">
                                                                    <h5>Check XXL</h5>
                                                                    <p>Umfassender Elektro-Check + FIN-Abfrage & Berechnung
                                                                    </p>
                                                                    <div class="rattings">
                                                                    <span class="star">
                                                                        <i style="color: #f2d414" class="fa-solid fa-star"></i>
                                                                    </span>
                                                                        <span class="ratting-text">4.8 (117)</span>
                                                                    </div>
                                                                </div>
                                                            </div>
  ...
  <div style="max-width: 1200px; margin: 0 auto; text-align: center;">
    ...
    <a href="{{route('booking.step-2',['type'=>('elektro')])}}" class="btn btn-secondary mt-5" style="border-radius: 5px; padding: 15px 60px">
          Jetzt starten
      ...
      <div class="col-md-6 text-center text-md-end">
                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="card-item text-primary d-flex flex-column justify-content-between text-center bg-white">
                            <div class="card-item-head">
                                ...
                                <h4 class="card-title fw-bold pt-1 pb-2">Elektro-Zustandsbericht </h4>
                            </div>
                            <p class="card-para text-black">Wir erstellen einen geprüften Elektro-Zustandsbericht, der eine professionelle und objektive Bewertung des gesamten Fahrzeugs bietet.</p>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="card-item text-primary d-flex flex-column justify-content-between text-center bg-white">
                            ...
                            <span class="icon mb-1" style="font-size: 2.5rem; background-color: #F0F5FA; padding: 0.5rem 1rem; border-radius: 5px; display: inline-block;">
                                ...
                                <h4 class="card-title fw-bold pt-1 pb-2">Batteriezertifikat State of Health (SoH)</h4>
                            </div>
                             <p class="card-para text-black">
                                Wir erstellen ein SoH-Zertifikat (State of Health), das den Gesundheits-Zustand der Hochvoltbatterie transparent darstellt.
                                </p>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="card-item text-primary d-flex flex-column justify-content-between text-center bg-white">
                            ...
                            <span class="icon mb-1" style="font-size: 2.5rem; background-color: #F0F5FA; padding: 0.5rem 1rem; border-radius: 5px; display: inline-block;">
                                ...
                                <h4 class="card-title fw-bold pt-1 pb-2">Batteriezustand & Restkapazität</h4>
                            </div>
                            <p class="card-para text-black">Wir prüfen Restkapazität, Ladeverhalten und mögliche Auffälligkeiten, um Reichweite und Batterieperformance einzuschätzen.</p>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="card-item text-primary d-flex flex-column justify-content-between text-center bg-white">
                            ...
                            <i class="fa-solid fa-plug-circle-check"></i>
                                ...
                                <h4 class="card-title fw-bold pt-1 pb-2">Ladeanschluss & Ladefunktions-Check</h4>
                            </div>
                            <p class="card-para text-black">Wir kontrollieren Ladebuchse, Verriegelung, Pins und Abdeckungen und testen die Ladefunktion, damit keine teuren Überraschungen entstehen.</p>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="card-item text-primary d-flex flex-column justify-content-between text-center bg-white">
                            ...
                            <i class="fa-solid fa-microchip"></i>
                                ...
                                <h4 class="card-title fw-bold pt-1 pb-2">Antrieb & Elektronikdiagnose</h4>
                            </div>
                            <p class="card-para text-black">Mit Diagnosetools lesen wir Fehlerspeicher aus und prüfen Antrieb, Inverter sowie relevante Steuergeräte – inklusive Warnmeldungen und Systemzuständen.</p>
                        </div>
                    </div>
        ...
        <div
                ...
                <span class="germany-flag-lg">
                    <img src="/tuv-gebrauchtwagenbewertung.png" style="height: 85px" alt="Germany Flag">
                </span>

                <h3 class="section-title tuv-section fs-3 text-primary">TÜV Rheinland<br>
            Gutachten-Partner</h3>
            </div>
<style>
                    ...
                    <div class="row flex-column-reverse flex-md-row align-items-center">
                        <div class="col-md-6">
                            <div class="ucc-text p-lg-5 pe-0 text-center text-md-start">
                                <h3 class="section-title fs-3 fw-bold text-primary pb-2">Elektro-Check vor Ort
                                </h3>

                                <div class="text-grey pt-1 pb-2 mb-1"><i style="color: #f2d414" class="fa-solid fa-star"></i>
                                                           4.8 (132 Bewertungen) </div>
            ...
            <div class="container">
                <div class="advantage-wrapper">
                    ...
                    <div class="pt-5 d-flex flex-column align-items-center justify-content-center">
                        <a href="{{route('booking.step-2',['type'=>('elektro')])}}" style="width: 350px; border-radius: 5px" class="btnwdnextStep btn btn-secondary ">
                                Jetzt buchen
            ...
            <div class="container">
                <div
                    ...
                    <div class="d-flex flex-column align-items-center justify-content-center">
                        <a href="{{route('booking.step-2',['type'=>('elektro')])}}" style="width: 350px; border-radius: 5px" class="nextStep btn btn-secondary ">
                                Jetzt Elektro-Check buchen
                                <span class="btn-icon"><img src="theme-1/imgs/icons/arrowr.png" style="height: 21px" alt="gebrauchtwagencheck"></span>
                        </a>
                    </div>
                </div>
...
<div class="modal-body pb-1" style="text-align: left;">
    ...
    <div class="d-flex align-items-center mb-2">
        ...
        <p class="fs-6 mb-0" style="padding-left:10px;">
    ...
    <ul class="list-unstyled">
        ...
        <li class="d-flex align-items-start gap-2 mb-2">
            <i class="fas fa-check-circle text-success mt-1"></i>
            <span>TÜV Rheinland Gutachten-Partner</span>
        </li>
        <li class="d-flex align-items-start gap-2 mb-2">
            <i class="fas fa-check-circle text-success mt-1"></i>
            <span>Objektive und unabhängige Fahrzeugbewertung</span>
        </li>
    </ul>
    ...
    <div class="alert alert-warning mt-3" style="font-size: 14px">
        ...
        In Einzelfällen kann es aufgrund des Standorts oder hoher Auslastung vorkommen, dass die Bearbeitung des Auftrags nicht durch den TÜV Rheinland, sondern durch einen anderen qualifizierten Partner erfolgt.
    </div>
