                    ...
                    <center><div class="col-lg-4">
                            ...
                            <div class="exam-card-header">
                                    <div class="exam-card-header-icon">
                                        <img src="assets/imgs/iconoption/sedan.png" alt="auto pkw kaufbegleitung gebrauchtwagencheck prüfung">
                                    </div><p style="text-align: left; font-size: 20px; font-weight: bold; padding-top: 15px">Auto/ PKW Kaufbegleitung</p>
                                </div>
                                <div id="multiCollapseExample1" class="multi-collapse show d-lg-block">
                                    <ul class="mb-4">
                                        <li>
                                            <span class="icon"><img src="front/imgs/icons/check-faq.png" alt="pkw autos check prüfung" height="25px"></span>
                                            PKW aller Bauarten
                                        </li>
                                        <li>
                                            <span class="icon"><img src="front/imgs/icons/check-faq.png" alt="kleintransporter" height="25px"></span>
                                            Kleintransporter
                                        </li>
                ...
                <div class="exam-cards">
                    ...
                    <div class="col-sm-6 col-lg-4">
                            <div class="exam-card">
                                <div class="exam-card-header">
                                    <div class="exam-card-header-icon">
                                        <img src="assets/imgs/iconadv/all-inclusive.png" alt="zertifiziertes gutachten auto gebrauchtwagencheck kaufbegleitung">
                                    </div><p style="text-align: left; font-size: 19px; font-weight: bold; padding-top: 10px">Alle Vorteile des All-Around-Checks</p>
                                </div>
                                <div style="text-align: left; font-size:17px" class="exam-card-body">
                                Alle Prüfungsinhalte des "All-Around-Checks" erhältst du auch bei der Kaufbegleitung. Alle Vorteile und Prüfpunkte findest du <a href="{{route('vorteile')}}">hier</a>.
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-6 col-lg-4">
                            <div class="exam-card">
                                <div class="exam-card-header">
                                    <div class="exam-card-header-icon">
                                        <img src="assets/imgs/iconadv/business-report.png" alt="gutachten zertifiziert tüv">
                                    </div><p style="text-align: left; font-size: 19px; font-weight: bold; padding-top: 10px">Zertifiziertes Gutachten</p>
                                </div>
                                <div style="text-align: left; font-size:17px" class="exam-card-body">
                                Wir erstellen ein zertifiziertes Gutachten, das eine professionelle und objektive Bewertung des Fahrzeugs bietet.
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-6 col-lg-4">
                            <div class="exam-card">
                                <div class="exam-card-header">
                                    <div class="exam-card-header-icon">
                                        <img src="assets/imgs/iconadv/handshake.png" alt="live dabei kaufbegleitung begleitung autokauf auto gebrauchtwagencheck">
                                    </div><p style="text-align: left; font-size: 19px; font-weight: bold; padding-top: 10px">LIVE dabei</p>
                                </div>
                                <div style="text-align: left; font-size:17px" class="exam-card-body">
                                Sei beim Check in Echtzeit dabei und verfolge die Fahrzeuginspektion hautnah. So kannst du den gesamten Prüfprozess direkt miterleben.
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-6 col-lg-4">
                            <div class="exam-card">
                                <div class="exam-card-header">
                                    <div class="exam-card-header-icon">
                                        <img src="assets/imgs/iconadv/question-mark.png" alt="fragen stellen experte auto">
                                    </div><p style="text-align: left; font-size: 19px; font-weight: bold; padding-top: 10px">Stelle deine Fragen</p>
                                </div>
                                <div style="text-align: left; font-size:17px" class="exam-card-body">
                                Nutze die Gelegenheit direkt, deine Fragen zu stellen. So erhältst du sofortige Antworten und kannst sicherstellen, dass du den Zustand deines Fahrzeugs vollständig verstehst.
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-6 col-lg-4">
                            <div class="exam-card">
                                <div class="exam-card-header">
                                    <div class="exam-card-header-icon">
                                        <img src="assets/imgs/iconadv/user.png" alt="individuelle wünsche autokauf">
                                    </div><p style="text-align: left; font-size: 19px; font-weight: bold; padding-top: 10px">Nenne deine Wünsche</p>
                                </div>
                                <div style="text-align: left; font-size:17px" class="exam-card-body">
                                Teile uns deine speziellen Wünsche mit. Wir passen den Check individuell an deine Bedürfnisse an und prüfen dein Fahrzeug nach deinen Vorstellungen.
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-6 col-lg-4">
                            <div class="exam-card">
                                <div class="exam-card-header">
                                    <div class="exam-card-header-icon">
                                        <img src="assets/imgs/iconadv/discount.png" alt="preisverhandlung verhandlung unterstützung hilfe kaufbegleitung">
                                    </div><p style="text-align: left; font-size: 19px; font-weight: bold; padding-top: 10px">Unterstützung in der Preisverhandlung</p>
                                </div>
                                <div style="text-align: left; font-size:17px" class="exam-card-body">
                                Nutze unseren detaillierten Prüfbericht als starkes Argument in Preisverhandlungen. Mit einer fundierten Bewertung des Zustands kannst du bessere Konditionen erzielen.
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col">
                        <div class="you-get-wrapper">
                            <div class="section-heading">
                                <h2 class="d-none d-sm-block">Carspector Kaufbegleitung</h2>
                                <h2 class="d-sm-none">Carspector<br>Kaufbegleitung</h2>
                            </div>
                    ...
                    <div class="col">
                        <div class="live-wrapper">
                            ...
                            <h2 class="text-center">Erhalte ein zertifiziertes Gutachten</h2>
                                ...
                                Wir prüfen deutschlandweit dein gewünschtes Fahrzeug vor dem Kauf nach unseren strengen Richtlinien und Vorgaben und 
                                erstellen ein <b>zertifiziertes Gebrauchtwagen-Gutachten</b>, das mehr als<br><b>150 verschiedene Prüfpunkte</b> abdeckt.
                                <br><br>
