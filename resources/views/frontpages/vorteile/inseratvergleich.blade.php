...
@section('title', 'Carspector | Inserate vergleichen lassen – Finde das bessere Angebot')
@section('meta_description', 'Mehrere Fahrzeuge im Blick? Wir vergleichen Inserate nach Preis, Zustand und Ausstattung und helfen dir bei der Auswahl des besten Angebots.')
@section('header')
...
@media (max-width: 768px) {
    ...
    <div class="container" style="display: flex; align-items: center;">
        ...
        <div class="content-box" style="flex: 1">
            ...
            Du hast mehrere Fahrzeuge im Blick, bist dir aber unsicher, welches das beste ist? Kein Problem! Wir vergleichen sie und erstellen eine detaillierte Rangliste für dich.
            </p>
            <button type="button" style="border-radius: 5px" data-bs-toggle="modal" data-bs-target="#exampleModal" class=" nextStep btn btn-secondary mt-4">
                Jetzt buchen
                <span class="btn-icon">
                ...
                <div class="ucc-3-wrapper">
                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="card-item text-primary d-flex flex-column justify-content-between text-center bg-white">
                            ...
                            <p class="card-para text-black">Wir vergleichen die Inserate basierend auf Preis, Mängeln, Ausstattung, Baujahr, Kilometerstand und weiteren Kriterien.</p>
                        </div>
                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="card-item text-primary d-flex flex-column justify-content-between text-center bg-white">
                            ...
                            <p class="card-para text-black">Wir analysieren den Marktwert der Fahrzeuge anhand aktueller Datenbanken und Marktdaten.</p>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="card-item text-primary d-flex flex-column justify-content-between text-center bg-white">
                            ...
                            <p class="card-para text-black">Wir überprüfen die Inserate auf Vollständigkeit, Glaubwürdigkeit und Professionalität.</p>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="card-item text-primary d-flex flex-column justify-content-between text-center bg-white">
                            ...
                            <p class="card-para text-black">Wir identifizieren verdächtige oder betrügerische Inserate durch spezialisierte Prüfverfahren.</p>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="card-item text-primary d-flex flex-column justify-content-between text-center bg-white">
                            ...
                            <p class="card-para text-black">Wir analysieren die Fahrzeugbilder auf Qualität, Vollständigkeit und mögliche Hinweise auf Mängel.</p>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="card-item text-primary d-flex flex-column justify-content-between text-center bg-white">
                            ...
                            <p class="card-para text-black">Wir berechnen die laufenden Kosten wie Versicherung, Steuer, Wartung und Treibstoffverbrauch.</p>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="card-item text-primary d-flex flex-column justify-content-between text-center bg-white">
                            ...
                            <p class="card-para text-black">Wir überprüfen die Fahrzeughistorie, z. B. Unfallfreiheit, Anzahl der Vorbesitzer und Wartungsberichte.</p>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="card-item text-primary d-flex flex-column justify-content-between text-center bg-white">
                            ...
                            <p class="card-para text-black">Wir recherchieren online und beim Hersteller, um typische Mängel und bekannte Probleme aufzulisten.</p>
                        </div>
                    </div>
        ...
        <section class="benefit-banner-section section-bg">
            <div class="container">
                <div
                    ...
                    <button data-bs-toggle="modal" style="border-radius: 5px" data-bs-target="#exampleModal"  type="button" class="openPopup nextStep btn btn-secondary mt-4">
                        Jetzt buchen
                        <span class="btn-icon">
                            <img src="theme-1/imgs/icons/arrowr.png" alt="">
                        </span>
         ...
         <section class="testimonial-section section-bg">
            <div class="container">
                        ...
                        <div class="swiper-wrapper">
                            <div style="border-radius: 5px" class="testimonial-card swiper-slide d-flex flex-column justify-content-between bg-white">
                                <div class="testimonial-info d-flex flex-column">
                                    ...
                                    "Der Vergleich von 5 Inseraten hat mir die Wahl leicht gemacht. Die Rangliste war hilfreich und gut strukturiert."
                                    </p>
                                </div>
                                <div class="client-info d-flex align-items-center justify-content-center gap-3">
                                    <i class="fa-solid fa-user icon-bg"></i>
                                    <p class="client-name">Miguel A.</p>
                                </div>
                            ...
                            <div style="border-radius: 5px" class="testimonial-card swiper-slide d-flex flex-column justify-content-between bg-white">
                                <div class="testimonial-info d-flex flex-column">
                                    ...
                                    <p class="testimonial-para text-center">
                                    "Sehr empfehlenswert für Leute, die sich unsicher sind, welches das beste Fahrzeug unter den vielen ist."
                                    </p>
                                </div>
                                <div class="client-info d-flex align-items-center justify-content-center gap-3">
                                    <i class="fa-solid fa-user icon-bg"></i>
                                    <p class="client-name">Annabelle T.</p>
                                </div>
                            </div>
                            <div style="border-radius: 5px" class="testimonial-card swiper-slide d-flex flex-column justify-content-between bg-white">
                                <div class="testimonial-info d-flex flex-column">
                                    ...
                                    <p class="testimonial-para text-center">
                                    "Vielen Dank! So habe ich mir die Besichtigung von mehreren Autos erspart. Bericht war schon nach 3h da!"
                                    </p>
                                </div>
                                <div class="client-info d-flex align-items-center justify-content-center gap-3">
                                    <i class="fa-solid fa-user icon-bg"></i>
                                    <p class="client-name">Joe H. R.</p>
                                </div>
                            </div>
                        </div>
                ...
                <h3 class="testimonial-info fw-bold text-primary text-center">
                    Bereits über <span class="text-secondary">150</span> Inserate erfolgreich analysiert und verglichen!
                </h3>
...
{{--        </div>--}}
        ...
        <div class="desk-pt modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        ...
                        <div class="popup" id="popupContent">
                            ...
                            <div style="overflow-y: hidden;overflow-x:hidden;width: 100%">
                                ...
                                <form action="{{route('votile.post')}}" method="POST">
                                    ...
                                    <button style="background-color: var(--secondary); width: 100% !important; height: 50px" type="submit" id="submitData"><b>Jetzt buchen</b></button>
                                    <button style="display: none" id="closePopup">Schließen</button>
                                </form>
                                <br>
                                Wir senden dir unseren detaillierten Vergleichsbericht innerhalb von 24h zu.
        ...
        if (anzahl >= 2 && anzahl <= 10) {
            for (let i = 1; i <= anzahl; i++) {
                ...
                input.type = 'text';
                input.name = `inserat[]`;
                input.placeholder = `Inserat-Link ${i}*`;
                input.required = true;
