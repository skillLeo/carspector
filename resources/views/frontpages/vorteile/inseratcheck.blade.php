...
@section('title', 'Carspector | Inserat-Check für Gebrauchtwagen – Anzeige prüfen lassen')
@section('meta_description', 'Lass dein Wunschfahrzeug schon vor der Besichtigung prüfen – mit unserem Inserat-Check erkennen wir unseriöse Angebote und versteckte Risiken frühzeitig.')
@section('header')
    ...
    <div class="container" style="display: flex; align-items: center;">
        ...
        <div class="content-box" style="flex: 1; padding-right: 20px;">
            ...
            <p style="max-width: 470px; margin-left: auto; margin-right: auto;">
                Wir erstellen einen Bericht der dir hilft, die Seriosität des Angebots einzuschätzen 
                und potenzielle Risiken zu minimieren.
            </p>
            <a href="https://buy.stripe.com/eVacOn3jF27n0Du7sQ?" class="btnwd nextStep btn btn-secondary mt-4">
                Jetzt buchen für 39 €
                <span class="btn-icon">
        ...
        <div class="image-box d-none d-xl-block" style="flex: 0.5; text-align: center;">
            <img src="theme-1/imgs/inserat/3.png" alt="inserat check prüfen lassen autoscout mobile online ebay kleinanzeigen" style="max-width: 100%; height: 315px; border-radius: 5px">
        </div>
    </div>
    <div class="image-box d-block d-xl-none pt-4" style="flex: 0.5; text-align: center;">
                <img src="theme-1/imgs/inserat/3.png" alt="inserat check prüfen lassen autoscout mobile online ebay kleinanzeigen" style="max-width: 90%; max-height: 315px; border-radius: 5px">
            </div>
</section>
        ...
        <section class="benefit-banner-section section-bg">
            <div class="container">
                <div
                    ...
                    <a href="https://buy.stripe.com/eVacOn3jF27n0Du7sQ?" class="btnwd btn btn-secondary benefit-banner-btn">
                    ...
                    <div class="row flex-column-reverse flex-md-row align-items-center">
                        <div class="col-md-6">
                            <div class="ucc-text p-lg-5 pe-0 text-center text-md-start">
                                <h3 class="section-title fs-3 fw-bold text-primary pb-2">Analyse innerhalb<br>von 24h!
                                </h3>
                        ...
                        <div class="col-md-6">
                            <div class="ucc-thumb text-end" style="text-align: center;">
                                <img src="theme-1/imgs/inserat/2.png" alt="inserat check prüfen lassen autoscout mobile online ebay kleinanzeigen" style="border-radius: 5px">
        ...
        <section class="why-is-important-section section-padding section-bg">
            <div class="container">
                <h3 class="section-title fs-3 text-primary text-center pb-4 mx-auto mb-4">Warum du den Inserat-Check nutzen solltest</h3>
                    ...
                    <div class="row g-3 g-sm-4">
                        <div class="col-md-6">
                            <div style="border-radius: 5px"
                                ...
                                src="theme-1/imgs/icons/check.png" alt="besichtigung"></span>
                                <p style="font-size: 17px; font-weight: 500">Spare dir unnötige Besichtigungen</p>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div style="border-radius: 5px"
                                class="car-check-importance d-flex align-items-center gap-4 bg-white text-primary fw-medium">
                                <span class="list-icon flex-shrink-0 d-inline-flex align-items-center"><img
                                        src="theme-1/imgs/icons/check.png" alt="inserat"></span>

                                <p style="font-size: 17px; font-weight: 500">Erfahre mehr, als im Inserat steht</p>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div style="border-radius: 5px"
                                class="car-check-importance d-flex align-items-center gap-4 bg-white text-primary fw-medium">
                                <span class="list-icon flex-shrink-0 d-inline-flex align-items-center"><img
                                src="theme-1/imgs/icons/check.png" alt="einfach schnell"></span>

                                <p style="font-size: 17px; font-weight: 500">Einfach & schnell</p>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div style="border-radius: 5px"
                                class="car-check-importance d-flex align-items-center gap-4 bg-white text-primary fw-medium">
                                <span class="list-icon flex-shrink-0 d-inline-flex align-items-center"><img
                                src="theme-1/imgs/icons/check.png" alt="experteneinschätzung"></span>

                                <p style="font-size: 17px; font-weight: 500">Experteneinschätzung</p>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div style="border-radius: 5px"
                                class="car-check-importance d-flex align-items-center gap-4 bg-white text-primary fw-medium">
                                <span class="list-icon flex-shrink-0 d-inline-flex align-items-center"><img
                                src="theme-1/imgs/icons/check.png" alt="zeit sparen"></span>

                                <p style="font-size: 17px; font-weight: 500">Zeitersparnis</p>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div style="border-radius: 5px"
                                class="car-check-importance d-flex align-items-center gap-4 bg-white text-primary fw-medium">
                                <span class="list-icon flex-shrink-0 d-inline-flex align-items-center"><img
                                src="theme-1/imgs/icons/check.png" alt="24h"></span>

                                <p style="font-size: 17px; font-weight: 500">Innerhalb von 24h</p>
                            </div>
                        </div>
                        <div class="d-flex justify-content-center pt-4 pt-mb-topt">
                            <a href="https://buy.stripe.com/eVacOn3jF27n0Du7sQ?" class="btnwd btn btn-secondary benefit-banner-btn text-center">
                                Jetzt buchen
                                <span class="btn-icon"><img src="theme-1/imgs/icons/arrowr.png" style="height: 21px" alt="inserat check prüfen lassen autoscout mobile online ebay kleinanzeigen"></span>
                            </a>
                        </div>
