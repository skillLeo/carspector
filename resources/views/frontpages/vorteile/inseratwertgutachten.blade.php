...
<meta charset="UTF-8">
    ...
    <title>Carspector - Inserat-Check</title>
                ...
                <ul>
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu" style="border-radius: 1 !important;z-index: 99999999 !important;padding: 8px 8px;">
                            ...
                            <li><a class="dropdown-item" href="{{route('inseratwertgutachten')}}">Inserat-Wertgutachten</a></li>
        ...
        <div class="container">
          <div class="hero-wrapper px-1 px-sm-0">
            ...
            <div style="text-align: center" class="justify-content-center align-items-center">
              <h1 class="fw-bold text-white"><span class="text-secondary">Inserat-Wertgutachten</span></h1>
              ...
              <p class="hero-para hp-2 text-white pb-4 mb-2 mb-sm-0">Du hast ein spannendes Fahrzeuginserat entdeckt, bist dir aber unsicher, ob der Preis passt? Mit unserem Inserat-Wertgutachten bekommst du eine zuverlässige Einschätzung des Fahrzeugpreises.</p>
    ...
    <section id="faq-section" class="faq-area section-bg">
        <div class="container-sm">
            <div class="section-heading">
                <center><h2>Deine Vorteile des Inserat-Wertgutachten</h2></center>
            </div>
