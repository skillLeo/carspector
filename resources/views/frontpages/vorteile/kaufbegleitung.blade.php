...
@section('title', 'Carspector | Kaufbegleitung für Gebrauchtwagen – sicher zum richtigen Auto')
@section('meta_description', 'Wir begleiten dich beim Autokauf – mit unabhängiger Beratung, professionellem Fahrzeugcheck und Unterstützung beim Kauf.')
@section('header')
...
<div class="modal fade" id="fin-model" tabindex="-1" aria-labelledby="stepDescModalLabel" aria-hidden="true">
        ...
        <section class="benefit-banner-section section-bg py-4 py-lg-5">
            <div class="container d-flex align-items-center justify-content-between">
                <div class="content-box" style="flex: 1;">
                    <h3 class="section-title fs-3 text-primary pb-2">Kaufbegleitung</h3>
                    <div class="text-grey pb-2 mb-1"><i style="color: #f2d414" class="fa-solid fa-star"></i> 4.7 (528) </div>
                    <p style="max-width: 470px; margin-left: auto; margin-right: auto;">
                        Unsere Experten begleiten dich bei der Besichtigung <br class="desktop-only-br">und prüfen dein gewünschtes Fahrzeug direkt <br class="desktop-only-br">beim Verkäufer – unabhängig, professionell <br class="desktop-only-br">und nach <br class="mobile-only-br">über 150 Prüfpunkten.
                    </p>
                    <a href="{{route('booking.step-2',['type'=>('kaufbegleitung')])}}" class="btnwd nextStep btn btn-secondary mt-4">
                        Jetzt buchen
                        <span class="btn-icon"><img src="theme-1/imgs/icons/arrowr.png" style="height: 21px" alt="kaufbegleitung"></span>
                    </a>
                    </div>
                <div class="image-box d-none d-xl-block" style="flex: 0.5; text-align: center; margin-left: 20px;">
                    <img src="theme-1/imgs/inserat/mwc.png" alt="kaufbegleitung" style="max-width: 100%; height: 315px; border-radius: 5px;">
                </div>
            </div>
            <div class="image-box d-block d-xl-none pt-4" style="flex: 0.5; text-align: center;">
                <img src="theme-1/imgs/inserat/mwc.png" alt="kaufbegleitung" style="max-width: 90%; max-height: 315px; border-radius: 5px">
            </div>
        </section>
            ...
            <div class="container">
                <div class="advantage-wrapper">
                    <div class="section-head text-center pb-4 mb-3">
                        <h3 class="section-title fs-3 text-primary pb-1">Deine Vorteile der Kaufbegleitung</h3>
                        ...
                        <div class="col-md-6 col-lg-4">
                                <div
                                    ...
                                    <i class="fa-regular fa-handshake"></i>
                                        ...
                                        <h4 class="card-title fw-bold pt-1 pb-2">LIVE-Check mit Experte</h4>
                                    </div>

                                    <p class="card-para text-black">
                                    Du verfolgst den Check hautnah und hast die einmalige Möglichkeit, einen Experten an deiner Seite zu haben.
                                    </p>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 col-lg-4">
                                <div
                                    ...
                                    <span class="icon mb-1" style="font-size: 2.5rem; background-color: #F0F5FA; padding: 0.5rem 1rem; border-radius: 5px; display: inline-block;">
                                        ...
                                        <h4 class="card-title fw-bold pt-1 pb-2">Stelle deine Fragen</h4>
                                    </div>

                                    <p class="card-para text-black">
                                    Stelle deine Fragen, nenne uns deine Wünsche - wir sind dein direkter Ansprechpartner vor Ort.
                                    </p>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 col-lg-4">
                                <div
                                    ...
                                    <div class="card-item-head">
                                        <span class="icon mb-1" style="font-size: 2.5rem; background-color: #F0F5FA; padding: 0.5rem 1rem; border-radius: 5px; display: inline-block;">
                                        <img src="assets/imgs/hpslider/4.png" style="height: 50px" alt="Germany Flag">
                                        </span>
  ...
  <div style="max-width: 1200px; margin: 0 auto; text-align: center;">
    <h3 style="color: var(--primary); margin-bottom: 60px">Wie funktioniert die Kaufbegleitung?</h3>
    <div style="display: flex; flex-direction: row; justify-content: space-between; gap: 40px; flex-wrap: wrap;">
      
      <!-- Schritt 1 -->
      <div style="flex: 1; min-width: 280px; text-align: center;">
        <img src="/step-1-bild.webp" alt="Wunschauto angeben" style="width: 160px; margin-bottom: 20px;">
        <div style="display: flex; justify-content: center; align-items: center; gap: 10px; margin-bottom: 10px;">
          ...
          <div style="font-size: 20px; font-weight: bold; color: var(--primary);">Buche die Kaufbegleitung</div>
        </div>
      ...
      <div class="pt-3 pt-sm-0" style="flex: 1; min-width: 280px; text-align: center;">
        <img src="/step-2-kb.webp" alt="Prüfung vor Ort" style="width: 200px; margin-bottom: 20px;">
        <div style="display: flex; justify-content: center; align-items: center; gap: 10px; margin-bottom: 10px;">
          <span style="background-color: var(--primary); color: white; border-radius: 50%; width: 32px; height: 32px; display: flex; align-items: center; justify-content: center; font-weight: bold; font-size: 16px;">
            2
          </span>
          <div style="font-size: 20px; font-weight: bold; color: var(--primary);">Wir treffen dich</div>
        </div>
        <p style="font-size: 16px; color: #333;">Wir kontaktieren dich, um einen Termin zu vereinbaren und treffen dich am Fahrzeug.</p>
      </div>

      <!-- Schritt 3 -->
      <div class="pt-3 pt-sm-0" style="flex: 1; min-width: 280px; text-align: center;">
        <img src="/step-3-kb.webp" alt="Zertifiziertes Gutachten" style="width: 170px; margin-bottom: 25px;">
        <div style="display: flex; justify-content: center; align-items: center; gap: 10px; margin-bottom: 10px;">
          <span style="background-color: var(--primary); color: white; border-radius: 50%; width: 32px; height: 32px; display: flex; align-items: center; justify-content: center; font-weight: bold; font-size: 16px;">
            3
          </span>
          <div style="font-size: 20px; font-weight: bold; color: var(--primary);">Check des Fahrzeugs</div>
        </div>
        <p style="font-size: 16px; color: #333;">Wir führen einen umfassenden Check deines gewünschten Fahrzeugs in deiner Anwesenheit durch.</p>
      </div>
      

    </div>
    <a href="{{route('booking.step-2',['type'=>('kaufbegleitung')])}}" class="btn btn-secondary mt-5" style="border-radius: 5px; padding: 15px 50px">
          Jetzt starten
...
<section class="pad-top-inhalt steps-area pb-5 pb-md-5">
                <form action="{{route('booking.step-3',['type'=>('')])}}" method="GET">
                    <input type="hidden" name="type" value="kaufbegleitung">
                <div class="container">
                                                            ...
                                                            <span class="ind">
                                                                <span class="dot"></span>
                                                                    ...
                                                                    <div class="check-nav-content">
                                                                        <h5>Check XL</h5>
                                                                        <p>Umfassende Kaufbegleitung</p>
                                                                        <div class="rattings">
                                                                    <span class="star">
                                                                    <i style="color: #f2d414" class="fa-solid fa-star"></i>
                                                                    </span>
                                                                            <span class="ratting-text">4.7 (129)</span>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                        ...
                                                        <div class="check-nav">
                                                            ...
                                                            <span class="ind">
                                                                <span class="dot"></span>
                                                                    ...
                                                                    <div class="check-nav-content">
                                                                        <h5>Check XXL</h5>
                                                                        <p>Umfassende Kaufbegleitung + FIN-Abfrage & Berechnung
                                                                        </p>
                                                                        <div class="rattings">
                                                                    <span class="star">
                                                                    <i style="color: #f2d414" class="fa-solid fa-star"></i>
                                                                    </span>
                                                                            <span class="ratting-text">4.7 (399)</span>
                                                                        </div>
                                                                    </div>
                                                                </div>
  ...
  <div class="trust-marquee">
    <div class="trust-marquee-inner">
      ...
      <span>🧾 Für Privatkunden & Händler geeignet</span>
        ...
        <section class="used-car-check-section-2 pt-mb-cst section-bg">
            <div class="container">
                <div class="ucc-2-wrapper mx-auto">
                    <div class="row flex-column-reverse flex-md-row align-items-center">
                        <div class="col-md-6">
                            <div class="ucc-text p-lg-5 pe-0 text-center text-md-start">
                                <h3 class="section-title fs-3 fw-bold text-primary pb-2">Du bist LIVE beim Check dabei!
                                </h3>

                                <div class="text-grey pb-2 mb-1"><i style="color: #f2d414" class="fa-solid fa-star"></i>
                                                           4.7 (528 Bewertungen)</div>

                                <p class="pt-2 text-primary">
                                    Wir prüfen dein gewünschtes Fahrzeug in deiner Anwesenheit, damit du über den technischen und
                        ...
                        <div class="col-md-6">
                            <div class="ucc-thumb text-end">
                                <img style="border-radius: 5px" src="theme-1/imgs/vorteile/kaufbegleitung.png" alt="Check Used Car">
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <!------- UsedCarCheck (2) OnSite Section End ------->
         ...
         <div
                class="ucc-4-top  section-padding d-flex flex-column flex-md-row justify-content-center align-items-center text-center text-md-start">
        ...
        <section class="used-car-check-section-3 section-bg">
            <div class="container">
            ...
            <div class="section-head text-center pb-4 mb-3">
                ...
                <div class="ucc-3-wrapper">
                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="card-item text-primary d-flex flex-column justify-content-between text-center bg-white">
                            <div class="card-item-head">
                                ...
                                <h4 class="card-title fw-bold pt-1 pb-2">Geprüfter Zustandsbericht</h4>
                            </div>
                            <p class="card-para text-black">Du erhältst einen professionellen Zustandsbericht mit objektiver Bewertung des gesamten Fahrzeugs.</p>
                        </div>  
                    </div>
                    ...
                    <a href="{{route('booking.step-2',['type'=>('kaufbegleitung')])}}" class="btnwd nextStep btn btn-secondary mt-0 mx-auto">
                            Jetzt buchen
            ...
            <div class="container">
                <div
                    ...
                    <div class="d-flex flex-column align-items-center justify-content-center">
                        <a href="{{route('booking.step-2',['type'=>('kaufbegleitung')])}}" style="width: 350px; border-radius: 5px" class="nextStep btn btn-secondary ">
