...
@section('title', 'Carspector | Wohnmobil-Check')
@section('meta_description', 'Gebrauchtwagenprüfung für Wohnmobile – mit Fokus auf Technik, Dichtheit, Ausstattung und Sicherheitssysteme.')
@section('header')
        ...
        <section class="benefit-banner-section section-bg py-4 py-lg-5">
            <div class="container d-flex align-items-center justify-content-between">
                <div class="content-box" style="flex: 1;">
                    <h3 class="section-title fs-3 text-primary pb-2">Wohnmobil-Check</h3>
                    <div class="text-grey pb-2 mb-1"><i style="color: #f2d414" class="fa-solid fa-star"></i> 4.8 (467)
                    </div>
                    <p style="max-width: 470px; margin-left: auto; margin-right: auto;">
                        Unsere Experten prüfen dein gewünschtes Wohnmobil <br class="desktop-only-br">direkt beim Verkäufer – unabhängig, professionell <br class="desktop-only-br">und nach über 150 Prüfpunkten.
                    </p>
                    <a href="{{route('booking.step-2',['type'=>('wohnmobil')])}}" class="btnwd nextStep btn btn-secondary mt-4">
                        Jetzt buchen
                        <span class="btn-icon"><img src="theme-1/imgs/icons/arrowr.png" style="height: 21px" alt="wohnmobil check"></span>
                    </a>
                    </div>
                <div class="image-box d-none d-xl-block" style="flex: 0.5; text-align: center; margin-left: 20px;">
                    <img src="theme-1/imgs/vorteile/wohnmobil.png" alt="wohnmobil check untersuchung prüfung gebrauchtwagencheck" style="max-width: 100%; height: 315px; border-radius: 5px;">
                </div>
            </div>
            <div class="image-box d-block d-xl-none pt-4" style="flex: 0.5; text-align: center;">
                    <img src="theme-1/imgs/vorteile/wohnmobil.png" alt="wohnmobil check untersuchung prüfung gebrauchtwagencheck" style="max-width: 90%; max-height: 315px; border-radius: 5px">
            </div>
        </section>
...
<section class="pad-top-inhalt steps-area pb-5 pb-md-5">
                <form action="{{route('booking.step-3',['type'=>('')])}}" method="GET">
                    <input type="hidden" name="type" value="wohnmobil">
                <div class="container">
 ...
 <div class="section-head text-center pb-4 mb-3">
                                                        ...
                                                        <label for="check1" class="active" id="nav-home-tab" data-bs-toggle="tab"
                                                            ...
                                                            <span class="ind">
                                                                ...
                                                                <div class="check-nav-content">
                                                                    <h5>Check XL</h5>
                                                                    <p>Umfassender Wohnmobil-Check</p>
                                                                    <div class="rattings">
                                                                    <span class="star">
                                                                    <i style="color: #f2d414" class="fa-solid fa-star"></i>
                                                                    </span>
                                                                        <span class="ratting-text">4.8 (55)</span>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                    ...
                                                    <div class="check-nav">
                                                        ...
                                                        <label for="check2" class="" id="nav-profile-tab"
                                                            ...
                                                            <span class="ind">
                                                                ...
                                                                <div class="check-nav-content">
                                                                    <h5>Check XXL</h5>
                                                                    <p>Umfassender Wohnmobil-Check + FIN-Abfrage & Berechnung
                                                                    </p>
                                                                    <div class="rattings">
                                                                    <span class="star">
                                                                    <i style="color: #f2d414" class="fa-solid fa-star"></i>
                                                                    </span>
                                                                        <span class="ratting-text">4.8 (412)</span>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                ...
                                                <div class="check-content">
                                                    <div class="check-cotnent-body">
                                                        <ul>
                                                            ...
                                                            <li>
                                                            <span>
                                                                <img src="theme-1/imgs/icons/check.png" alt=">"></span>
                                                            </span>
                                                                Dokumentenprüfung
                                                            </li>
                                                            <li>
  ...
  <div style="max-width: 1200px; margin: 0 auto; text-align: center;">
    <h3 style="color: var(--primary); margin-bottom: 60px">In 3 Schritten sicher zum neuen Wohnmobil</h3>
    ...
    <a href="{{route('booking.step-2',['type'=>('wohnmobil')])}}" class="btn btn-secondary mt-5" style="border-radius: 5px; padding: 15px 60px">
          Jetzt starten
                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="card-item text-primary d-flex flex-column justify-content-between text-center bg-white">
                            <div class="card-item-head">
                                ...
                                <h4 class="card-title fw-bold pt-1 pb-2">Wohnmobil-Zustandsbericht </h4>
                            </div>
                            <p class="card-para text-black">Wir erstellen einen geprüften Wohnmobil-Zustandsbericht, der eine professionelle und objektive Bewertung des gesamten Fahrzeugs bietet.</p>
                        </div>
                    ...
                    <div class="row flex-column-reverse flex-md-row align-items-center">
                        <div class="col-md-6">
                            <div class="ucc-text p-lg-5 pe-0 text-center text-md-start">
                                <h3 class="section-title fs-3 fw-bold text-primary pb-2">Wohnmobil-Check<br>vor Ort
                                </h3>

                                <div class="text-grey pb-2 mb-1 pt-1"><i style="color: #f2d414" class="fa-solid fa-star"></i>
                                                           4.8 (467 Bewertungen) </div>

                                <p class="pt-2 text-primary">
                                    Wir prüfen dein gewünschtes Wohnmobil vor dem Kauf, damit du über den technischen und
                        ...
                        <div class="col-md-6">
                            <div class="ucc-thumb text-end">
                                <img src="theme-1/imgs/thumbs/used-car-2-thumb.jpg" alt="wohnmobil gebrauchtwagencheck" style="border-radius: 5px">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="container">
                <div class="advantage-wrapper">
                    ...
                    <div class="pt-5 d-flex flex-column align-items-center justify-content-center">
                        <a href="{{route('booking.step-2',['type'=>('wohnmobil')])}}" style="width: 350px; border-radius: 5px" class="btnwdnextStep btn btn-secondary ">
                                Jetzt buchen
            ...
            <div class="container">
                <div
                    ...
                    <div class="d-flex flex-column align-items-center justify-content-center">
                        <a href="{{route('booking.step-2',['type'=>('wohnmobil')])}}" style="width: 350px; border-radius: 5px" class="nextStep btn btn-secondary ">
                                Jetzt Wohnmobil-Check buchen
                                <span class="btn-icon"><img src="theme-1/imgs/icons/arrowr.png" style="height: 21px" alt="gebrauchtwagencheck"></span>
                        </a>
                    </div>
                </div>
