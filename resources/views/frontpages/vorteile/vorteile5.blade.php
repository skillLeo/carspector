                    ...
                    <center><div class="col-lg-4">
                            ...
                            <div class="exam-card-header">
                                    <div class="exam-card-header-icon">
                                        <img src="assets/imgs/iconoption/caravan.png" alt="wohnmobil prüfung gebrauchtwagencheck gutachten zustand">
                                        </div><p style="text-align: left; font-size: 20px; font-weight: bold; padding-top: 15px">Wohnmobil Prüfung</p>
                                </div>
                                <div id="multiCollapseExample3" class="multi-collapse show show d-lg-block">
                                    <ul class="mb-4">

                                        <li>
                                            <span class="icon"><img src="front/imgs/icons/check-faq.png" alt="wohnmobil alle marken und modelle" height="25px"></span>
                                            Alle Marken und Modelle
                                        </li>
                                        <li>
                                            <span class="icon"><img src="front/imgs/icons/check-faq.png" alt="individuelle prüfung" height="25px"></span>
                                            Individuell gestaltet
                                        </li>
                                    </ul>
                                </div>
                                <a href="{{route('index')}}" class="section-btn" style="width: 100%">Jetzt anfragen</a>
                    ...
                    <div class="row g-lg-5 g-md-4 g-sm-3 pb-4">
                        ...
                        <div class="col-sm-6 col-lg-4">
                            <div class="exam-card">
                                <div class="exam-card-header">
                                    <div class="exam-card-header-icon">
                                        <img src="assets/imgs/iconadv/business-report.png" alt="Zertifiziertes Wohnmobil Gutachten">
                                    </div><p style="text-align: left; font-size: 19px; font-weight: bold; padding-top: 10px">Zertifiziertes Wohnmobil-Gutachten</p>
                                </div>
                                <div style="text-align: left; font-size:17px" class="exam-card-body">
                                Wir erstellen ein zertifiziertes Wohnmobil-Gutachten, das eine professionelle und objektive Bewertung des Fahrzeugs bietet.
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-6 col-lg-4">
                    ...
                    <div class="col">
                        <div class="you-get-wrapper">
                            <div class="section-heading">
                                <h2 class="d-none d-sm-block">Unsere Wohnmobil Prüfung</h2>
                                <h2 class="d-sm-none">Unsere Wohnmobil Prüfung</h2>
                            </div>
                            <div class="you-get-list d-flex">
                                ...
                                <div class="you-get-list-row">
                                    <ul>
                                        ...
                                        <li><b>Zertifiziertes Wohnmobil-Gutachten</b></li>
                ...
                <div class="row">
                    <div class="col">
                        <div class="live-wrapper">
                            <div class="section-heading">
                            <h2 class="text-center">Erhalte ein zertifiziertes Wohnmobil Gutachten</h2>
                                <p style="font-size: 19px" class="paragraph text-center d-none d-sm-block">
                                Wir prüfen deutschlandweit dein gewünschtes Wohnmobil vor dem Kauf nach unseren strengen Richtlinien und Vorgaben und 
                                erstellen ein <b>zertifiziertes Wohnmobil-Gutachten</b>, das mehr als<br><b>150 verschiedene Prüfpunkte</b> abdeckt.
                                <br><br>
                                ...
                                Wir prüfen deutschlandweit dein gewünschtes Wohnmobil vor dem Kauf nach unseren strengen Richtlinien und Vorgaben und
                                erstellen ein <b>zertifiziertes Wohnmobil-Gutachten</b>, das mehr als <b>150 verschiedene Prüfpunkte</b> abdeckt.
                                <br><br>
