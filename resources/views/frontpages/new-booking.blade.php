                        ...
                        <form action="{{route('booking.send')}}" method="POST">
                            ...
                            <div class="login-inner">
                                <div class="step-item--header mb-5">
                                    <h2 style="letter-spacing: -1.5px">Als Partner bewerben</h2>
                                    <p class="fs-6 pt-3">Du bist Kfz-Gutachter? Bewirb dich für unser kostenloses Netzwerk und erhalte Aufträge für verschiedene Dienstleistungen.<p>
                                </div>
                                <div class="form-content">
                                    <div class="form-inpus">
                                        ...
                                        <div class="mb-3 input-box">
                                            <textarea class="form-control" name="desc" style="background-color: #f8f8f8; box-shadow: none; border: 1px solid #ddd" placeholder="Qualifikationen, Erfahrungen, zusätzliche Angaben*">{{old('desc')}}</textarea>
                                            @error('desc')
                                            <div class="invalid-feedback d-block">{{$message}}</div>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="form-text text-center pt-2 pt-md-0">
                                            ...
                                            <p class="fs-6">Mit dem Absenden deiner Bewerbung akzeptierst du unsere <a class="text-primary" href="{{route('agb')}}">AGB</a> und die <a class="text-primary" href="{{route('datenschutz')}}">Datenschutzerklärung</a>.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
