...
@section('title', "Gebrauchtwagencheck für {$brandTitle} – vor Ort & deutschlandweit")
@section('meta_description', "Jetzt Gebrauchtwagencheck für {$brandTitle} buchen – umfassende Vor-Ort-Prüfung mit über 150 Prüfpunkten, Fotodokumentation & Marktwertanalyse.")
...
{!! json_encode([
  ...
  "@type" => "Service",
  "name" => "Gebrauchtwagencheck {$brandTitle}",
  ...
  <div class="container">
    <div class="row align-items-center g-4">
      ...
      <div class="col-lg-6 text-center text-lg-start">
        ...
        <h1 class="hero-title">
          Gebrauchtwagen-Check für {{ $brandTitle }}
        </h1>
        ...
        <ul style="padding-top: 3px" class="hero-bullets">
          ...
          <li><span class="bullet-check">✓</span> Deutschlandweit verfügbar</li>
        </ul>
...
<!-- 
  ...
  <div style="max-width: 1200px; margin: 0 auto; text-align: center;">
    <h3 style="color: var(--primary); margin-bottom: 60px">So läuft unser Gebrauchtwagencheck für {{ $brandTitle }} ab</h3>
...
<section class="pad-top-inhalt steps-area pb-4 mb-4 pb-md-0">
 ...
 <div class="section-head text-center pb-4 mb-4">
                        <h3 class="section-title fs-3 text-primary pb-2">Prüfungsinhalte: Gebrauchtwagencheck {{ $brandTitle }}</h3>
                                ...
                                <div class="pt-desk step-item-content pricing-select">
                                    ...
                                    <div class="pt-3 pb-3 check-bottom d-flex flex-column align-items-center justify-content-center">
                                        <button type="submit" style="border-radius: 5px; min-width: 350px" class="btndk nextStep btn btn-secondary ">
...
<style>
  ...
  <div class="container">
    <h3 class="section-title fs-3 fw-bold text-primary text-center pb-5 mb-2">
      Fragen zum Gebrauchtwagencheck für {{ $brandTitle }}
    </h3>
...
<script>
  ...
  },
  {
    ...
    answer: `<b>Unsere Experten fahren direkt zum Fahrzeugstandort</b> – egal ob privat oder beim Autohaus – und prüfen dein Wunschauto umfassend vor Ort. 
             <br><br>
             Wir arbeiten ausschließlich mit <b>qualifizierten Kfz-Prüfern</b> in ganz Deutschland zusammen, um dir eine professionelle und unabhängige Fahrzeugbewertung zu garantieren.`
  },
  {
  ...
  {
    question: "Prüft Carspector auch {{ $brandTitle }}?",
    answer: `Ja, selbstverständlich! Unsere <b>qualifizierten Prüfer</b> führen regelmäßig Gebrauchtwagenchecks für <b>{{ $brandTitle }}</b> durch. 
             So erhältst du eine unabhängige Bewertung über den technischen und optischen Zustand des {{ $brandTitle }}.`
  },
  {
  ...
  },
  {
    ...
    answer: `Unsere Prüfungen werden ausschließlich von <b>qualifizierten Kfz-Meistern oder -Technikern</b> mit langjähriger Erfahrung durchgeführt. 
