...
@section('title', 'Gebrauchtwagencheck für Škoda – zertifiziert & vor Ort')
@section('meta_description', 'Jetzt Gebrauchtwagencheck für Škoda buchen – zertifizierte Vor-Ort-Prüfung mit über 150 Prüfpunkten, Fotodokumentation & Marktwertanalyse.')
@section('header')
...
<a href="#tel" data-bs-target="#tel" data-bs-toggle="modal" class=" mobile-call-btn d-flex justify-content-center align-items-center">
   ...
   <div id="stickyBar">
        <div id="stickyButton" onclick="window.location.href='https://carspector.de/booking-step-1';">Škoda Check buchen</div>
    </div>
...
<div class="mobile-menu d-xl-none">
  <div class="offcanvas offcanvas-end bg-primary" tabindex="-1" id="offcanvasRight" aria-labelledby="offcanvasRightLabel">
    ...
    <div class="pad-top container">
        <div class="hero-wrapper mx-auto text-center">
            <h1 style="letter-spacing: -2px; font-size: 75px; padding-bottom: 20px" class="pad-para-f tlemain section-title text-white fw-bold">Gebrauchtwagen-Check für <span class="animate-check" style="color: var(--secondary)">Škoda</span></h1>
        ...
        <div class="col-md-6">
          <div class="ucc-text text-center text-md-start p-lg-5 pe-0">
            ...
            <p style="font-size: 17px" class="pt-2 pb-4 text-primary">
              Wir fahren zu deinem gewünschten <b>Škoda</b> und führen einen <b>umfassenden Gebrauchtwagencheck</b> vor Ort durch,
  ...
  <div style="max-width: 1200px; margin: 0 auto; text-align: center;">
    <h3 style="color: var(--primary); margin-bottom: 60px">So läuft unser Gebrauchtwagencheck für Škoda ab</h3>
...
<section class="pad-top-inhalt steps-area pb-4 mb-4 pb-md-0">
 ...
 <div class="section-head text-center pb-4 mb-4">
                        <h3 class="section-title fs-3 text-primary pb-2">Prüfungsinhalte: Gebrauchtwagencheck Škoda</h3>
        ...
        <div class="swiper-slide" style="height: auto; min-height: 475px; display: flex; justify-content: center;">
          ...
          <div class="swiper-slide" style="height: auto; min-height: 475px; display: flex; justify-content: center;">
            <div class="card elevated-card shadow border-0 rounded mx-auto" style="max-width: 350px;">
              ...
              <div class="card-body">
                <h5 class="card-title fw-bold mb-1 text-dark">ClŠkodaa H.</h5>
                <p class="mb-2" style="color: var(--secondary); font-size: 1.2rem;">★★★★★</p>
                <p class="card-text text-dark" style="font-size: 0.95rem;">
    ...
    <div class="row align-items-center flex-column-reverse flex-md-row">
      ...
      <div class="col-md-6 text-center text-md-start">
        ...
        <p class="pb-1 text-primary" style="font-size: 17px;">
          <b>Kein Weg zum Fahrzeug nötig</b> – unsere Experten übernehmen das für dich. Wir führen einen detaillierten Gebrauchtwagencheck deines gewünschten Škoda durch und senden dir 
...
<section class="faq-section">
  <div class="container">
    <h3 class="section-title fs-3 fw-bold text-primary text-center pb-5 mb-2">
      Fragen zum Gebrauchtwagencheck für Škoda
    </h3>
...
<script>
  ...
  {
    question: "Prüft Carspector auch Škoda?",
    answer: `Ja, selbstverständlich! Unsere <b>zertifizierten Prüfer</b> führen regelmäßig Gebrauchtwagenchecks für <b>Škoda</b> durch. 
             So erhältst du eine unabhängige Bewertung über den technischen und optischen Zustand des Škoda.`
  },
  {
