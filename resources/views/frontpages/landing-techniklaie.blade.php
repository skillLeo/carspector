        ...
        <div class="header-wrapper index-header d-flex align-items-center justify-content-center justify-content-md-between mx-auto position-relative">
            ...
            <div class="header-logo">
                <a href="{{url('/')}}" class="logo d-inline-flex align-items-center gap-3">
                    ...
                    <span style="font-size: 16px" class="fw-semibold d-none d-lg-block">Auto gecheckt, <br>sicher gekauft.</span>
                </a>
            </div>
            <!-- header-logo-end -->
            ...
            <div class="header-end align-items-center d-none d-lg-flex">
                <div class="header-nav">
                    ...
                    <li style="letter-spacing: 0.25px" class="header-nav-item position-relative">
                        <a href="{{route('rezensionen')}}"
                           class="header-nav-link fw-semibold position-relative d-inline-flex align-items-center">Rezensionen</a>
                    </li>
                    <li style="letter-spacing: 0.25px" class="header-nav-item position-relative">
                        <a href="{{route('faq')}}"
                    ...
                    <a href="{{route('login')}}" style="letter-spacing: 0.25px; border-radius: 5px" class="btn btn-outline header-btn">Anmelden</a> 
                    </ul>
                </div>
            </div>
            <!-- header-right-end -->
...
<div class="mobile-menu d-lg-none">
  <div class="offcanvas offcanvas-end bg-primary" tabindex="-1" id="offcanvasRight" aria-labelledby="offcanvasRightLabel">
        ...
        <div class="offcanvas-body">
            ...
            <div class="accordion" id="accordionMenu">
                <ul>
                    ...
                    <li class="mobile-nav-item"><a href="{{route('rezensionen')}}"
    ...
    <div class="pad-top container">
        ...
        <h1 style="padding-bottom: 17px" class="tlemain h1main page-title fs-1 text-white fw-bold pad-para-f">Keine Ahnung<br class="d-sm-none"> von Technik?</h1>
                
                <p style="padding-bottom: 15px" class="para-dk main-hero-para text-white">
                        Unsere Experten prüfen das Fahrzeug für<br class="d-sm-none"> dich – transparent & verlässlich.
                    </p>

                    <!-- <div class="pt-1 pb-3 image-section">
                    <img src="homepagebild.png" alt="Illustration: Person prüft Auto aus der Ferne">
                    </div> -->
...
<section class="checklist-section bg-white py-5">
  <div class="container">
    <h3 class="section-title fw-bold text-primary text-center mb-5">
      Deine Vorteile unseres Gebrauchtwagen-<br>Checks
    </h3>

    <div class="pt-2 row justify-content-center" style="max-width: 1140px; margin: 0 auto;">
      
      <div class="col-md-6 d-flex align-items-start gap-3 mb-4">
        <div class="icon-box d-flex align-items-center justify-content-center flex-shrink-0"
             style="width: 56px; height: 56px; background: #f2f6ff; border-radius: 50%; box-shadow: 0 2px 6px rgba(0,0,0,0.08);">
          <i style="font-size: 1.5rem" class="fa-regular fa-file-certificate text-primary"></i>
        </div>
        <div>
          <h5 class="mb-1">Zertifiziertes Gutachten</h5>
          <p class="text-muted mb-0 small">Wir erstellen ein zertifiziertes Gutachten, das eine professionelle und objektive Bewertung des gesamten Fahrzeugs bietet.</p>
        </div>
      </div>
      ...
      <div class="col-md-6 d-flex align-items-start gap-3 mb-4">
        <div class="icon-box d-flex align-items-center justify-content-center flex-shrink-0"
             style="width: 56px; height: 56px; background: #f2f6ff; border-radius: 50%; box-shadow: 0 2px 6px rgba(0,0,0,0.08);">
          <i style="font-size: 1.5rem" class="fa-regular fa-folder-open text-primary fs-5"></i>
        </div>
        <div>
          <h5 class="mb-1">Dokumentenprüfung</h5>
          <p class="text-muted mb-0 small">Wir prüfen alle Fahrzeugdokumente wie Zulassungsbescheinigung, Fahrzeugbrief und Serviceheft auf Vollständigkeit und Authentizität.</p>
        </div>
      </div>
      ...
      <div class="col-md-6 d-flex align-items-start gap-3 mb-4">
        <div class="icon-box d-flex align-items-center justify-content-center flex-shrink-0"
             style="width: 56px; height: 56px; background: #f2f6ff; border-radius: 50%; box-shadow: 0 2px 6px rgba(0,0,0,0.08);">
          <i style="font-size: 1.5rem" class="fa-regular fa-paint-roller text-primary fs-5"></i>
        </div>
        <div>
          <h5 class="mb-1">Lackschichtmessung & Analyse</h5>
          <p class="text-muted mb-0 small">Durch die Messung der Lackschichtdicke erkennen wir, ob das Fahrzeug nachlackiert wurde, was auf mögliche Unfallschäden hinweist.</p>
        </div>
      </div>
      ...
      <div class="col-md-6 d-flex align-items-start gap-3 mb-4">
        <div class="icon-box d-flex align-items-center justify-content-center flex-shrink-0"
             style="width: 56px; height: 56px; background: #f2f6ff; border-radius: 50%; box-shadow: 0 2px 6px rgba(0,0,0,0.08);">
          <i style="font-size: 1.5rem" class="fa-solid fa-car-burst text-primary fs-5"></i>
        </div>
        <div>
          <h5 class="mb-1">Prüfung auf Unfallschäden</h5>
          <p class="text-muted mb-0 small">Wir setzen spezielle Prüfmethoden und visuelle Inspektionen ein, um versteckte Unfallschäden am Fahrzeug zu identifizieren und zu bewerten.</p>
        </div>
      </div>
      ...
      <div class="col-md-6 d-flex align-items-start gap-3 mb-4">
        <div class="icon-box d-flex align-items-center justify-content-center flex-shrink-0 "
             style="width: 56px; height: 56px; background: #f2f6ff; border-radius: 50%; box-shadow: 0 2px 6px rgba(0,0,0,0.08);">
          <i style="font-size: 1.5rem" class="fa-regular fa-gear text-primary fs-5"></i>
        </div>
        <div>
          <h5 class="mb-1">Bauteil & Fahrwerks-Analyse</h5>
          <p class="text-muted mb-0 small">Wir analysieren die Bauteile und das Fahrwerk, um technische Defekte und Verschleiß zu identifizieren. Dabei werden sämtliche relevanten Komponenten geprüft.</p>
        </div>
      </div>
      ...
      <div class="col-md-6 d-flex align-items-start gap-3 mb-4">
        <div class="icon-box d-flex align-items-center justify-content-center flex-shrink-0 "
             style="width: 56px; height: 56px; background: #f2f6ff; border-radius: 50%; box-shadow: 0 2px 6px rgba(0,0,0,0.08);">
          <i style="font-size: 1.5rem" class="fa-regular fa-tire text-primary fs-5"></i>
        </div>
        <div>
          <h5 class="mb-1">Reifen & Bremsen</h5>
          <p class="text-muted mb-0 small">Wir prüfen Profiltiefe, Alter und Zustand der Reifen sowie den Verschleißgrad der Bremsen. So lassen sich sicherheitsrelevante Mängel frühzeitig erkennen.</p>
        </div>
      </div>
      ...
      <div class="col-md-6 d-flex align-items-start gap-3 mb-4">
        <div class="icon-box d-flex align-items-center justify-content-center flex-shrink-0"
             style="width: 56px; height: 56px; background: #f2f6ff; border-radius: 50%; box-shadow: 0 2px 6px rgba(0,0,0,0.08);">
          <i style="font-size: 1.5rem" class="fa-regular fa-engine text-primary fs-5"></i>
        </div>
        <div>
          <h5 class="mb-1">Motor- & Elektronikdiagnose</h5>
          <p class="text-muted mb-0 small">Mit modernen Diagnosegeräten prüfen wir den Zustand des Motors und der elektronischen Systeme und identifizieren mögliche Fehler oder Probleme.</p>
        </div>
      </div>
      ...
      <div class="col-md-6 d-flex align-items-start gap-3 mb-4">
        <div class="icon-box d-flex align-items-center justify-content-center flex-shrink-0"
             style="width: 56px; height: 56px; background: #f2f6ff; border-radius: 50%; box-shadow: 0 2px 6px rgba(0,0,0,0.08);">
          <i style="font-size: 1.5rem" class="fa-solid fa-tablet-rugged text-primary fs-5"></i>
        </div>
        <div>
          <h5 class="mb-1">OBD2-Fehlerspeicher</h5>
          <p class="text-muted mb-0 small">Über die OBD2-Schnittstelle lesen wir sämtliche gespeicherten Fehlercodes aus, die auf Probleme in Motorsteuerung, Abgasanlage oder anderen Systemen hinweisen können.</p>
        </div>
      </div>
        ...
        <div class="icon-box d-flex align-items-center justify-content-center flex-shrink-0"
             style="width: 56px; height: 56px; background: #f2f6ff; border-radius: 50%; box-shadow: 0 2px 6px rgba(0,0,0,0.08);">
          <i style="font-size: 1.5rem" class="fa-regular fa-gauge text-primary fs-5"></i>
        </div>
        <div>
          <h5 class="mb-1">Kilometerstand-Check</h5>
          <p class="text-muted mb-0 small">Wir prüfen den Kilometerstand auf Plausibilität, um Manipulationen zu erkennen und die tatsächliche Laufleistung des Fahrzeugs sicherzustellen.</p>
        </div>
      </div>
      ...
      <div class="col-md-6 d-flex align-items-start gap-3 mb-4">
        <div class="icon-box d-flex align-items-center justify-content-center flex-shrink-0"
             style="width: 56px; height: 56px; background: #f2f6ff; border-radius: 50%; box-shadow: 0 2px 6px rgba(0,0,0,0.08);">
          <i style="font-size: 1.5rem" class="fa-regular fa-car-tunnel text-primary fs-5"></i>
        </div>
        <div>
          <h5 class="mb-1">Umfassende Probefahrt</h5>
          <p class="text-muted mb-0 small">Wir führen eine Probefahrt durch, um das Fahrverhalten, die Lenkung, die Bremsen und andere fahrrelevante Systeme des Fahrzeugs unter realen Bedingungen zu testen.</p>
        </div>
      </div>
      ...
      <div class="col-md-6 d-flex align-items-start gap-3 mb-4">
        <div class="icon-box d-flex align-items-center justify-content-center flex-shrink-0"
             style="width: 56px; height: 56px; background: #f2f6ff; border-radius: 50%; box-shadow: 0 2px 6px rgba(0,0,0,0.08);">
          <i style="font-size: 1.5rem" class="fa-regular fa-steering-wheel text-primary fs-5"></i>
        </div>
        <div>
          <h5 class="mb-1">Prüfung des Innenraums</h5>
          <p class="text-muted mb-0 small">Wir untersuchen den Innenraum auf Sauberkeit, Abnutzung und Funktionalität aller Bedienelemente und Ausstattungsteile, um Komfort und Qualität zu bewerten.</p>
        </div>
      </div>
      ...
      <div class="col-md-6 d-flex align-items-start gap-3 mb-4">
        <div class="icon-box d-flex align-items-center justify-content-center flex-shrink-0"
             style="width: 56px; height: 56px; background: #f2f6ff; border-radius: 50%; box-shadow: 0 2px 6px rgba(0,0,0,0.08);">
          <i style="font-size: 1.5rem" class="fa-regular fa-camera text-primary fs-5"></i>
        </div>
        <div>
          <h5 class="mb-1">Fotodokumentation</h5>
          <p class="text-muted mb-0 small">Wir erstellen eine umfassende Fotodokumentation, die den Zustand des Fahrzeugs visuell festhält und für spätere Referenzen zur Verfügung steht.</p>
        </div>
      </div>
      ...
      <div class="col-md-6 d-flex align-items-start gap-3 mb-4">
        <div class="icon-box d-flex align-items-center justify-content-center flex-shrink-0"
             style="width: 56px; height: 56px; background: #f2f6ff; border-radius: 50%; box-shadow: 0 2px 6px rgba(0,0,0,0.08);">
          <i style="font-size: 1.5rem" class="fa-regular fa-heart text-primary fs-5"></i>
        </div>
        <div>
          <h5 class="mb-1">Individuelle Wünsche</h5>
          <p class="text-muted mb-0 small">Selbstverständlich berücksichtigen wir deine persönlichen Wünsche und Vorstellungen und prüfen alle relevanten Details.</p>
        </div>
      </div>
      ...
      <div class="col-md-6 d-flex align-items-start gap-3 mb-4">
        <div class="icon-box d-flex align-items-center justify-content-center flex-shrink-0"
             style="width: 56px; height: 56px; background: #f2f6ff; border-radius: 50%; box-shadow: 0 2px 6px rgba(0,0,0,0.08);">
          <i style="font-size: 1.5rem" class="fa-regular fa-circle-euro text-primary fs-5"></i>
        </div>
        <div>
          <h5 class="mb-1">Ermittlung des Marktwertes</h5>
          <p class="text-muted mb-0 small">Wir ermitteln den aktuellen Marktwert basierend auf Zustand, Kilometerstand, Ausstattung und aktuellen Marktdaten.</p>
        </div>
      </div>
      ...
      <div class="col-md-6 d-flex align-items-start gap-3 mb-4">
        <div class="icon-box d-flex align-items-center justify-content-center flex-shrink-0"
             style="width: 56px; height: 56px; background: #f2f6ff; border-radius: 50%; box-shadow: 0 2px 6px rgba(0,0,0,0.08);">
          <i style="font-size: 1.5rem" class="fa-regular fa-calculator text-primary fs-5"></i>
        </div>
        <div>
          <h5 class="mb-1">Ermittlung von Minderwerten und Folgekosten</h5>
          <p class="text-muted mb-0 small">Wir fassen alle Mängel zusammen und ziehen daraus Schlüsse über mögliche Minderwerte und anstehende Kosten.</p>
        </div>
      </div>
      ...
      <div class="col-md-6 d-flex align-items-start gap-3 mb-4">
        <div class="icon-box d-flex align-items-center justify-content-center flex-shrink-0"
             style="width: 56px; height: 56px; background: #f2f6ff; border-radius: 50%; box-shadow: 0 2px 6px rgba(0,0,0,0.08);">
          <i style="font-size: 1.5rem" class="fa-solid fa-laptop-code text-primary fs-5"></i>
        </div>
        <div>
          <h5 class="mb-1">FIN-Abfrage</h5>
          <p class="text-muted mb-0 small">
            ...
            <a href="#fin-model" data-bs-toggle="modal" class="ms-1">
              <i class="fa-regular fa-circle-info text-primary fs-6"></i>
            </a>
          </p>
        </div>
      </div>
      ...
      <div class="col-md-6 d-flex align-items-start gap-3 mb-4">
        <div class="icon-box d-flex align-items-center justify-content-center flex-shrink-0"
             style="width: 56px; height: 56px; background: #f2f6ff; border-radius: 50%; box-shadow: 0 2px 6px rgba(0,0,0,0.08);">
          <i style="font-size: 1.5rem" class="fa-solid fa-list-check text-primary fs-5"></i>
        </div>
        <div>
          <h5 class="mb-1">Verhandlungs-Checkliste</h5>
          <p class="text-muted mb-0 small">Du erhältst eine strukturierte Aufstellung aller festgestellten Mängel und Argumente, die dir eine fundierte und selbstsichere Preisverhandlung ermöglichen..</p>
        </div>
      </div>
  ...
  <div class="icon-box d-flex align-items-center justify-content-center flex-shrink-0"
       style="width: 56px; height: 56px; background: #f2f6ff; border-radius: 50%; box-shadow: 0 2px 6px rgba(0,0,0,0.08);">
    <i style="font-size: 1.5rem" class="fa-regular fa-badge-check text-primary fs-5"></i>
  </div>
  <div>
    <h5 class="mb-1">Experteneinschätzung</h5>
    <p class="text-muted mb-0 small">Unsere erfahrenen Fachleute geben eine detaillierte Einschätzung des Fahrzeugzustands und bieten dir wertvolle Ratschläge.</p>
  </div>
</div>
    ...
    <div style="padding-top: 35px" class="d-flex flex-column align-items-center justify-content-center">
