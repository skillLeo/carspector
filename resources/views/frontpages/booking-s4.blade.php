...
@section('title', 'Carspector | Check-Buchung ')
  ...
  <div class="container">
    <div class="header-wrapper d-flex flex-wrap align-items-center justify-content-center justify-content-md-between mx-auto position-relative">
      <div class="header-logo">
        <a href="#" class="logo d-inline-flex align-items-center gap-3"><img
...
@php
  ...
  $basePrice = 0;
  if(request('option')=='1'){
    if(request('type')=='Auto/ PKW') $basePrice=299; elseif(request('type')=='transporter') $basePrice=349; elseif(request('type')=='sportwagen') $basePrice=349; elseif(request('type')=='oldtimer') $basePrice=349; elseif(request('type')=='wohnmobil') $basePrice=399; elseif(request('type')=='kaufbegleitung') $basePrice=329;
  }elseif(request('option')=='2'){
    if(request('type')=='Auto/ PKW') $basePrice=349; elseif(request('type')=='transporter') $basePrice=399; elseif(request('type')=='sportwagen') $basePrice=399; elseif(request('type')=='oldtimer') $basePrice=399; elseif(request('type')=='wohnmobil') $basePrice=449; elseif(request('type')=='kaufbegleitung') $basePrice=379;
  }
@endphp
  ...
  <div class="container">
    <div class="booking-grid">
      ...
      <aside class="order-summary">
        <div class="panel summary" aria-label="Buchungszusammenfassung">
          <div class="panel-header">
            <h3>Deine Buchung</h3>
            <span class="badge-inline"><i class="fa-solid fa-car-side text-primary" aria-hidden="true"></i></span>
          </div>
          <div class="panel-body">
            ...
            <div id="priceText" class="mb-2">
              ...
              <strong><span id="basePrice">299</span> €</strong>
            </div>

            <!-- Button -->
            <button class="btn-check-details mt-1" type="button" data-bs-toggle="collapse" data-bs-target="#checkDetails">
              Prüfungsinhalte ansehen
              <i class="fa-solid fa-chevron-down ms-2"></i>
            </button>

            <!-- Ausklappbereich -->
            <div class="collapse mt-3" id="checkDetails">
              <div class="check-details-box">

                <ul class="check-list">
                  <li><i class="fa-solid fa-check-circle icon"></i> Zertifiziertes Gutachten</li>
                  <li><i class="fa-solid fa-check-circle icon"></i> Dokumentenprüfung</li>
                  <li><i class="fa-solid fa-check-circle icon"></i> Lackschichtmessung & Analyse</li>
                  <li><i class="fa-solid fa-check-circle icon"></i> Prüfung auf Unfallschäden</li>
                  <li><i class="fa-solid fa-check-circle icon"></i> Bauteil- & Fahrwerks-Check</li>
                  <li><i class="fa-solid fa-check-circle icon"></i> Prüfung von Reifen & Bremsen</li>
                  <li><i class="fa-solid fa-check-circle icon"></i> Motor- & Elektronikdiagnose</li>
                  <li><i class="fa-solid fa-check-circle icon"></i> OBD2-Fehlerspeicher-Auslese</li>
                  <li><i class="fa-solid fa-check-circle icon"></i> Umfassende Probefahrt</li>
                  <li><i class="fa-solid fa-check-circle icon"></i> Kilometerstand-Check</li>
                  <li><i class="fa-solid fa-check-circle icon"></i> Prüfung des Innenraums</li>
                  <li><i class="fa-solid fa-check-circle icon"></i> Fotodokumentation</li>
                  <li><i class="fa-solid fa-check-circle icon"></i> Individuelle Wünsche</li>
                </ul>
              ...
              <div class="row-price tot">
                ...
                <strong><span class="tot" id="totalPrice">299</span><span style="font-weight: 600"> €</span></strong>
              </div>
            </div>
      ...
      <section class="order-form">
        ...
        <div class="panel-header h-flex-3">
  <h3>Daten eingeben und Check starten</h3>
  ...
  <!-- <a href="#serviceFlow" data-bs-toggle="modal"
    ...
    Wie läuft das ab?
          ...
          <div class="panel-body">
            ...
            {{-- E-Mail --}}
            <div class="mb-3 form-floating-like">
              <input type="email" class="form-control" name="email" value="{{ old('email')?old('email'):request('email') }}" id="email" placeholder=" ">
    ...
    <div class="step-content">
      <strong>Zusendung des Prüfergebnisses</strong>
            ...
            <!-- <div class="booking-info text-center mt-4">
              ...
              @else
                <p class="info-text">
                  Direkt nach Buchungseingang kontaktieren wir den Verkäufer,<br class="break-lg">
      ...
      <div class="modal-body">
        ...
        @else
          ...
          <div class="step">
            ...
            <div>
              <h6 style="letter-spacing: -0.2px">4. Gutachten per E-Mail</h6>
