...
@section('title', 'Carspector | Gebrauchtwagencheck – professionelle Fahrzeugprüfung deutschlandweit')
@section('meta_description', 'Jetzt Gebrauchtwagencheck deutschlandweit buchen – umfassende Vor-Ort-Prüfung mit über 150 Prüfpunkten, Fotodokumentation & Marktwertanalyse.')
@section('header')
      ...
      <div class="col-lg-6 text-center text-lg-start">
        ...
        <ul style="padding-top: 3px" class="hero-bullets">
          ...
          <!-- <li class="d-flex align-items-center gap-2">
            ...
            <span>&nbsp;Offizieller TÜV Rheinland Partner</span>
            <a href="#tuv_modal" data-bs-toggle="modal" data-bs-target="#tuv_modal">
...
<section class="checklist-section py-5">
  ...
  <div class="container">
     <h3 class="section-title fs-3 fw-bold text-primary text-center mb-3">
      Deine Vorteile unseres Gebrauchtwagen-Checks
    </h3>
...
Carspector zählt zu den <b>führenden Anbietern für Gebrauchtwagenchecks</b> in ganz Deutschland und prüft Fahrzeuge aller Klassen. Dazu gehören unter anderem Autos/ PKW, Transporter, Oldtimer, Sportwagen und Wohnmobile. Deinen persönlichen Gebrauchtwagencheck kannst du deutschlandweit schnell und unkompliziert mit nur wenigen Klicks buchen.
                                            ...
                                            <div style="margin-bottom: 15px !important; border-radius: 5px" class="accordion-item">
                                              ...
                                              <div id="faq-four3" class="accordion-collapse collapse" data-bs-parent="#accordionFlushExample">
                                                  <div class="accordion-body">
                                                      ...
                                                      Nach Abschluss erhältst du das Prüfergebnis inklusive Bilder und aller relevanten Informationen bequem per E-Mail.
                                                  </div>
                                              </div>
                                          </div>
                                            <div style="margin-bottom: 15px !important; border-radius: 5px" class="accordion-item">
                                            ...
                                            <div style="margin-bottom: 15px !important; border-radius: 5px" class="accordion-item">
                                                <h2 class="accordion-header">
                                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                                            data-bs-target="#faq-717" aria-expanded="false" aria-controls="faq-717">
                                                        Wer führt die Gebrauchtwagenchecks durch?
                                                    </button>
                                                </h2>
                                                <div id="faq-717" class="accordion-collapse collapse" data-bs-parent="#accordionFlushExample">
                                                    <div class="accordion-body">
                                                        Unsere Prüfungen werden ausschließlich von <b>qualifizierten Kfz-Meistern oder -Technikern</b> mit langjähriger Erfahrung durchgeführt. 
