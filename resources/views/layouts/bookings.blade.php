                    ...
                    <div class="card-header border-0 pt-5">
                        ...
                        <div class="card-title d-flex flex-column align-items-start gap-0">
                            <div class="d-flex booking-scope-tabs mb-3" role="group" aria-label="Booking filters">
                                <button type="button" class="btn btn-sm btn-outline-primary active" data-booking-scope="all">Alle</button>
                                <button type="button" class="btn btn-sm btn-outline-primary" data-booking-scope="new">Neu</button>
                                <button type="button" class="btn btn-sm btn-outline-primary" data-booking-scope="active">Aktive Aufträge</button>
                                <button type="button" class="btn btn-sm btn-outline-primary" data-booking-scope="ready">Fertigstellung</button>
                                <button type="button" class="btn btn-sm btn-outline-danger" data-booking-scope="storno">Problem</button>
                            </div>
