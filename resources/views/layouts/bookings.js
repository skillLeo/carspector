    ...
    return {
        init: function () {
            ...
            e = $(o).DataTable({
                ...
                autoWidth: true,
                columnDefs: [
                    { targets: [0, 1, 2, 3,  8], className: 'align-middle text-nowrap' },
                ...
                columns:[
                    ...
                    //         return "";
                    //     }},
                    {data:'admin_order_date_display', name:'admin_order_date', width:'100px'},
                    ...
                    {data:'vehicle_type', name:'vehicle_type', width:'130px'},
                    {data:'status', name:'admin_status', width:'85px'},
                    {data:'vehicle_display', name:'vehicle_make_model', width:'180px'},
                    {data:'customer_display', name:'customer_name', width:'200px'},
                    {data:'examiner_display', name:'examiner_name', width:'200px'},
                    {data:'appointment_display', name:'appointment_date', width:'140px', orderable:true},
