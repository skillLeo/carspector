...
@section('breadcrumb')
<div class="row mb-2">
    <div class="col-sm-6"><h1 class="m-0">Partners</h1></div>
    <div class="col-sm-6">
...
@section('content')
                ...
                <div class="card">
                    ...
                    <div class="card-header border-0 pt-6">
                        ...
                        <div class="card-title">
                            ...
                            <div class="d-flex align-items-center position-relative my-1">
                                ...
                                <!--end::Svg Icon-->
                                <input type="text" data-kt-user-table-filter="search" class="form-control form-control-solid w-250px ps-14" placeholder="Search partners" />
                            </div>
                            <!--end::Search-->
                        </div>
                        <!--begin::Card title-->
                        ...
                        <div class="card-toolbar">
                            ...
                            <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                                ...
                                <div class="menu menu-sub menu-sub-dropdown w-300px w-md-325px" data-kt-menu="true">
                                    ...
                                    <div class="px-7 py-5" data-kt-user-table-filter="form">
                                        ...
                                        <div class="mb-10">
                                            ...
                                            <select class="form-select form-select-solid fw-bold city" data-kt-select2="true" data-placeholder="Select option" data-allow-clear="true" data-kt-user-table-filter="two-step" data-hide-search="true">
                                                <option></option>
                                ...
                                <button type="button" class="btn btn-primary" id="add-user">
                                    ...
                                    <!--end::Svg Icon-->Add Partner</button>
                                <!--end::Add user-->
                            </div>
                            <!--end::Toolbar-->
                            <!--begin::Group actions-->
                                                ...
                                                <div class="d-flex flex-column scroll-y me-n7 pe-7" id="kt_modal_add_user_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_user_header" data-kt-scroll-wrappers="#kt_modal_add_user_scroll" data-kt-scroll-offset="300px">
                                                    ...
                                                    <div class="fv-row m-auto mb-7">
                                                        ...
                                                        <div class="image-input image-input-outline image-input-placeholder" data-kt-image-input="true">
                                                            ...
                                                            <div class="image-input-wrapper w-125px h-125px avatar-img" style="background-image: url({{ asset('assets/media/avatars/300-6.jpg') }});"></div>
                                                    ...
                                                    <div class="fv-row mb-7">
                                                        ...
                                                        <!--end::Label-->
                                                        <!--begin::Input-->
                                                        <input type="text" name="promo_code" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Promo Code" value="" />
                                                        <!--end::Input-->
                                                    </div>
                                                    <!--end::Input group-->
                                                    <!--begin::Input group-->
                                                    <div class="mb-7">
                                                        ...
                                                        <div class="d-flex fv-row">
                                                            ...
                                                            <div class="form-check form-check-custom form-check-solid">
                                                                <!--begin::Input-->
                                                                <input class="form-check-input me-3" name="type" type="radio" value="partner" id="type" checked="checked" />
                                                                <!--end::Input-->
                                                                <!--begin::Label-->
                                                                <label class="form-check-label" for="type">
                                                                    <div class="fw-bold text-gray-800">Partner</div>
                                                                    <div class="text-gray-600">Partner Dashboard </div>
                                                                </label>
                                                                <!--end::Label-->
                                                            </div>
                    ...
                    <div class="card-body py-4">
                        <!--begin::Table-->
                        <table class="table align-middle table-row-dashed fs-6 gy-5 w-100" id="kt_table_users">
                            <!--begin::Table head-->
                            <thead>
                            <!--begin::Table row-->
...
@section('js')
    <script src="{{ asset('custom/partners.js') }}"></script>
    ...
    <script>
        $(document).on('click','.edit-btn',function (e){
            ...
            //     document.querySelector('#examiner').checked = true;
    ...
    <script>
        $('#add-user').click(function (){
            ...
            modal.find('[name=type]').val('partner');
