...
@section('breadcrumb')
<div class="row mb-2">
    <div class="col-sm-6"><h1 class="m-0">Unverified</h1></div>
    <div class="col-sm-6">
                                                    ...
                                                    <div class="mb-7">
                                                        ...
                                                        <div class="d-flex fv-row">
                                                            ...
                                                            <div class="form-check form-check-custom form-check-solid">
                                                                <!--begin::Input-->
                                                                <input class="form-check-input me-3" name="type" type="radio" value="admin" id="admin" checked='checked' />
                                                                <!--end::Input-->
                                                                <!--begin::Label-->
...
@section('js')
    <script src="{{ asset('custom/unverified.js') }}"></script>
