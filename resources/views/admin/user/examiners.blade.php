...
@section('breadcrumb')
<div class="row mb-2">
    <div class="col-sm-6"><h1 class="m-0">Examiners</h1></div>
    <div class="col-sm-6">
                        ...
                        <div class="card-toolbar">
                            ...
                            <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                                ...
                                <div class="dropdown me-3">
                                    <button type="button" class="btn btn-light-primary dropdown-toggle" data-bs-toggle="dropdown" data-bs-auto-close="outside" aria-expanded="false">
                                        <i class="fas fa-filter me-1"></i> Filter
                                    </button>
                                    <div class="dropdown-menu p-4" style="min-width:300px;">
                                        <div class="fw-bold mb-3 fs-6">Filter Options</div>
                                        <hr class="my-2">
...
@section('js')
    <script src="{{ asset('custom/examiners.js') }}"></script>
