...
@section('content')
    <!--begin::Card-->
    <div class="card withdraw-requests-card">
        <!--begin::Card header-->
...
@section('styles')
    <style>
        ...
        .withdraw-requests-card .table-responsive {
            width: 100%;
            overflow-x: auto;
        }

        .withdraw-requests-card #kt_table_users {
            min-width: 1200px;
        }

        .withdraw-requests-card #kt_table_users td,
        .withdraw-requests-card #kt_table_users th {
