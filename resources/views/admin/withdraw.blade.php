...
@section('breadcrumb')
<div class="row mb-2">
    <div class="col-sm-6"><h1 class="m-0">Withdraw Requests</h1></div>
    <div class="col-sm-6">
                                ...
                                <div class="menu menu-sub menu-sub-dropdown w-300px w-md-325px" data-kt-menu="true">
                                    ...
                                    <div class="px-7 py-5" data-kt-user-table-filter="form">
                                        ...
                                        <div class="mb-10">
                                            ...
                                            <select class="form-select form-select-solid fw-bold check-status" data-kt-select2="true" data-placeholder="Select option" data-allow-clear="true" data-kt-user-table-filter="role" data-hide-search="true">
                                                <option></option>
                    ...
                    <div class="card-body py-4">
                        ...
                        <table class="table align-middle table-row-dashed fs-6 gy-5 w-100" id="kt_table_users">
                            ...
                            <tr class="text-start text-muted fw-bold fs-7 text-uppercase gs-0">
                                ...
                                <th class="">Withdraw Method</th>
                                <th class="">Paypal Email</th>
                                <th class="">Account Title</th>
                                <th class="">IBAN/ Account No</th>
                                <th class="">Amount</th>
                                <th class="">Status</th>
                                <th class="">Created</th>
...
@section('js')
    <script src="{{ asset('custom/withdraw.js') }}"></script>
