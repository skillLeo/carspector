<div class="modal-body">
    ...
    <div class="row">
        ...
        <div class="col-7 col-md-3 pt-2 pt-md-3 pt-lg-3 pt-xl-3">
            <div class="profile-info ps-2 ps-sm-2 ps-lg-0 ps-md-0 ps-xl-0">
                ...
                <a data-id="{{$user->id}}"  href="#writeReview" data-target="#writeReview" data-bs-toggle="modal"  type="button" style="background-color: white !important; color: black !important; border: 1px solid black !important;width: 135px !important;" class="btn btn1 py-2 btn-primary  btn-write-review d-none d-md-block d-lg-block d-xl-block mt-2" id="newReview">Bewerten</a>
            </div>
        </div>
        ...
        <div class="col-12  d-block d-md-none py-3 d-lg-none d-xl-none" style="border-bottom: 1px solid #C1C1C1">
            <div class="row">
                <div class="col-7 pe-0 me-0 ">
                    <a href="#" type="button" style="font-size: 12px !important;line-height: 13.5px" class="btn btn1 px-0 mx-0 btn-primary w-100" id="allReview">Bewertungen ansehen</a>
                </div>
                <div class="col-5 ">
                    <a data-id="{{$user->id}}"  href="#writeReview" data-target="#writeReview" data-bs-toggle="modal"  type="button" style="font-size: 12px!important;line-height: 17.5px;background-color: white !important; color: black !important; border: 1px solid black !important;" class="btn btn1 py-2 btn-primary btn1 btn-write-review w-100" id="newReview">Bewerten</a>
                </div>
            </div>
        </div>
        ...
        <div class="col-6 col-md-4 pt-3 text-center d-none d-md-block d-lg-block d-xl-block">
            <div class="profile-meta">
                <ul class="text-center justify-content-center">
                    ...
                    <li>
                        <button type="button" style="font-size: 14px" class="btn btn1 btn-primary py-2 px-0 w-100  d-none d-md-block d-lg-block d-xl-block " id="allReview">Bewertungen ansehen</button>
                    </li>
                </ul>
            </div>
        </div>
    ...
    <div class="row">
            ...
            <div class="profile-info-item">
                <div class="row">
                    <div class="col-12 pb-4 d-block d-md-none d-lg-none d-xl-none">
                        <a href="{{route('booking.step1',['id'=>$user->id])}}" type="button" class="btn btn1 mt-3 py-4 btn-secondary btn-icon btn-shadow w-100 rounded-4">
                            <span class="text text-center text-white" style="font-size: 14px">Nächster Schritt</span>
                        </a>
                    </div>
                    <div class="col-12 pt-4">
                        <button type="button" class="btn btn1 py-2 w-100 btn-white btn-icon" style="border:1px solid black !important;">
                    ...
                    <div class="col-12 pt-2">
                        <button type="button" class="btn btn1 py-2 w-100 btn-primary btn-icon" style="border:1px solid black">
                            <span class="text text-white  text-start"><a href="{{route('support')}}" style="color: white!important;font-size: 14px!important;display: block;height: 100%;width: 100%">Fragen? Support</a></span>
        ...
        <div class="col-lg-6 pt-4 d-none d-md-block d-lg-block d-xl-block" style="vertical-align: center">
            <div class="profile-info-item">
                <a href="{{route('booking.step1',['id'=>$user->id])}}" type="button" class="btn mt-2  btn-secondary btn-icon w-100 rounded-4">
