...
@php
    ...
    $currentStatus = $order->admin_status;
    if (in_array($currentStatus, ['Prüfung', 'Pruefung'])) {
        $currentIndex = 0;
    } elseif ($currentStatus === 'Fertigstellung') {
        $currentIndex = 1;
    } elseif (in_array($currentStatus, ['Completed', 'Abgeschlossen'])) {
        $currentIndex = 2;
    } else {
        $currentIndex = 0;
    }
