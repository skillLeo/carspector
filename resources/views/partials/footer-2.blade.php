                    ...
                    <div class="footer-content pe-lg-4">
                        <div class="footer-logo">
                            <div class="d-flex align-items-center">
                                <img src="{{ asset('assets/img/logo/logo-primary-blue.png') }}" alt="" height="50" widht="50">
                                <h2 class="ps-3">Carspector</h2>
                            </div>
                            <p class="">Gebrauchtwagen kauft man mit uns</p>
                        </div>
                        <div class="footer-newsletter">
                            <p class=" mb-3">Registriere dich jetzt für E-Mail Newsletter und erhalte
                                Angebote, Rabtte und vieles mehr direkt in dein Postfach!</p>
