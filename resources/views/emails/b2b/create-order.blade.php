                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            <label class="form-label fw-semibold" for="make_year">
                                First Registration <span class="text-muted fw-normal">(MM.YYYY)</span>
                            </label>
                        ...
                        <div class="col-md-6 mb-3">
                            <label class="form-label fw-semibold" for="mileage">
                                Mileage <span class="text-muted fw-normal">(km)</span>
                            </label>
                ...
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        ...
                        <select id="vehicle_country" name="vehicle_country"
                            ...
                            @php
                                $countries = ['Germany','Netherlands','Belgium','Austria','Switzerland','France','Poland','Denmark','Luxembourg','Czech Republic','Other'];
                            @endphp
