                            ...
                            <div class="login-inner">
                                ...
                                <div class="form-content">
                                    <div class="form-inpus">
                                        ...
                                        <div class="mb-3 input-box">
                                            <input type="text" name="email" class="form-control" style="background-color: #f8f8f8; box-shadow: none; border: 1px solid #ddd" value="{{old('email')}}"  placeholder="E-Mail*">
                                            @error('email')
                                            <span class="invalid-feedback d-block" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                                    ...
                                    @error('terms')
                                        <div class="invalid-feedback d-block mb-3">Bitte akzeptieren Sie die AGB und Datenschutzerklärung.</div>
                                    @enderror
                                        ...
                                        <div class="form-text text-center pt-2 pt-md-0">
                                            <button type="submit" id="submit-btn" disabled style="border-radius: 5px" class="btn btn-primary w-100">
                                                Account erstellen
